import{i as e,r as t}from"./DocumentFields-C0F1xt2d.js";var{entries:n,setPrototypeOf:r,isFrozen:i,getPrototypeOf:a,getOwnPropertyDescriptor:o}=Object,{freeze:s,seal:c,create:l}=Object,{apply:u,construct:d}=typeof Reflect<`u`&&Reflect;s||=function(e){return e},c||=function(e){return e},u||=function(e,t){var n=[...arguments].slice(2);return e.apply(t,n)},d||=function(e){return new e(...[...arguments].slice(1))};var f=S(Array.prototype.forEach),p=S(Array.prototype.lastIndexOf),m=S(Array.prototype.pop),h=S(Array.prototype.push),ee=S(Array.prototype.splice),g=Array.isArray,_=S(String.prototype.toLowerCase),te=S(String.prototype.toString),v=S(String.prototype.match),y=S(String.prototype.replace),ne=S(String.prototype.indexOf),re=S(String.prototype.trim),ie=S(Number.prototype.toString),ae=S(Boolean.prototype.toString),oe=typeof BigInt>`u`?null:S(BigInt.prototype.toString),se=typeof Symbol>`u`?null:S(Symbol.prototype.toString),b=S(Object.prototype.hasOwnProperty),ce=S(Object.prototype.toString),x=S(RegExp.prototype.test),le=ue(TypeError);function S(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);var n=[...arguments].slice(1);return u(e,t,n)}}function ue(e){return function(){return d(e,[...arguments])}}function C(e,t){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:_;if(r&&r(e,null),!g(t))return e;let a=t.length;for(;a--;){let r=t[a];if(typeof r==`string`){let e=n(r);e!==r&&(i(t)||(t[a]=e),r=e)}e[r]=!0}return e}function de(e){for(let t=0;t<e.length;t++)b(e,t)||(e[t]=null);return e}function w(e){let t=l(null);for(let[r,i]of n(e))b(e,r)&&(g(i)?t[r]=de(i):i&&typeof i==`object`&&i.constructor===Object?t[r]=w(i):t[r]=i);return t}function fe(e){switch(typeof e){case`string`:return e;case`number`:return ie(e);case`boolean`:return ae(e);case`bigint`:return oe?oe(e):`0`;case`symbol`:return se?se(e):`Symbol()`;case`undefined`:return ce(e);case`function`:case`object`:{if(e===null)return ce(e);let t=e,n=T(t,`toString`);if(typeof n==`function`){let e=n(t);return typeof e==`string`?e:ce(e)}return ce(e)}default:return ce(e)}}function T(e,t){for(;e!==null;){let n=o(e,t);if(n){if(n.get)return S(n.get);if(typeof n.value==`function`)return S(n.value)}e=a(e)}function n(){return null}return n}function pe(e){try{return x(e,``),!0}catch{return!1}}var me=s(`a.abbr.acronym.address.area.article.aside.audio.b.bdi.bdo.big.blink.blockquote.body.br.button.canvas.caption.center.cite.code.col.colgroup.content.data.datalist.dd.decorator.del.details.dfn.dialog.dir.div.dl.dt.element.em.fieldset.figcaption.figure.font.footer.form.h1.h2.h3.h4.h5.h6.head.header.hgroup.hr.html.i.img.input.ins.kbd.label.legend.li.main.map.mark.marquee.menu.menuitem.meter.nav.nobr.ol.optgroup.option.output.p.picture.pre.progress.q.rp.rt.ruby.s.samp.search.section.select.shadow.slot.small.source.spacer.span.strike.strong.style.sub.summary.sup.table.tbody.td.template.textarea.tfoot.th.thead.time.tr.track.tt.u.ul.var.video.wbr`.split(`.`)),he=s(`svg.a.altglyph.altglyphdef.altglyphitem.animatecolor.animatemotion.animatetransform.circle.clippath.defs.desc.ellipse.enterkeyhint.exportparts.filter.font.g.glyph.glyphref.hkern.image.inputmode.line.lineargradient.marker.mask.metadata.mpath.part.path.pattern.polygon.polyline.radialgradient.rect.stop.style.switch.symbol.text.textpath.title.tref.tspan.view.vkern`.split(`.`)),ge=s([`feBlend`,`feColorMatrix`,`feComponentTransfer`,`feComposite`,`feConvolveMatrix`,`feDiffuseLighting`,`feDisplacementMap`,`feDistantLight`,`feDropShadow`,`feFlood`,`feFuncA`,`feFuncB`,`feFuncG`,`feFuncR`,`feGaussianBlur`,`feImage`,`feMerge`,`feMergeNode`,`feMorphology`,`feOffset`,`fePointLight`,`feSpecularLighting`,`feSpotLight`,`feTile`,`feTurbulence`]),_e=s([`animate`,`color-profile`,`cursor`,`discard`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`foreignobject`,`hatch`,`hatchpath`,`mesh`,`meshgradient`,`meshpatch`,`meshrow`,`missing-glyph`,`script`,`set`,`solidcolor`,`unknown`,`use`]),ve=s(`math.menclose.merror.mfenced.mfrac.mglyph.mi.mlabeledtr.mmultiscripts.mn.mo.mover.mpadded.mphantom.mroot.mrow.ms.mspace.msqrt.mstyle.msub.msup.msubsup.mtable.mtd.mtext.mtr.munder.munderover.mprescripts`.split(`.`)),ye=s([`maction`,`maligngroup`,`malignmark`,`mlongdiv`,`mscarries`,`mscarry`,`msgroup`,`mstack`,`msline`,`msrow`,`semantics`,`annotation`,`annotation-xml`,`mprescripts`,`none`]),be=s([`#text`]),xe=s(`accept.action.align.alt.autocapitalize.autocomplete.autopictureinpicture.autoplay.background.bgcolor.border.capture.cellpadding.cellspacing.checked.cite.class.clear.color.cols.colspan.controls.controlslist.coords.crossorigin.datetime.decoding.default.dir.disabled.disablepictureinpicture.disableremoteplayback.download.draggable.enctype.enterkeyhint.exportparts.face.for.headers.height.hidden.high.href.hreflang.id.inert.inputmode.integrity.ismap.kind.label.lang.list.loading.loop.low.max.maxlength.media.method.min.minlength.multiple.muted.name.nonce.noshade.novalidate.nowrap.open.optimum.part.pattern.placeholder.playsinline.popover.popovertarget.popovertargetaction.poster.preload.pubdate.radiogroup.readonly.rel.required.rev.reversed.role.rows.rowspan.spellcheck.scope.selected.shape.size.sizes.slot.span.srclang.start.src.srcset.step.style.summary.tabindex.title.translate.type.usemap.valign.value.width.wrap.xmlns`.split(`.`)),Se=s(`accent-height.accumulate.additive.alignment-baseline.amplitude.ascent.attributename.attributetype.azimuth.basefrequency.baseline-shift.begin.bias.by.class.clip.clippathunits.clip-path.clip-rule.color.color-interpolation.color-interpolation-filters.color-profile.color-rendering.cx.cy.d.dx.dy.diffuseconstant.direction.display.divisor.dur.edgemode.elevation.end.exponent.fill.fill-opacity.fill-rule.filter.filterunits.flood-color.flood-opacity.font-family.font-size.font-size-adjust.font-stretch.font-style.font-variant.font-weight.fx.fy.g1.g2.glyph-name.glyphref.gradientunits.gradienttransform.height.href.id.image-rendering.in.in2.intercept.k.k1.k2.k3.k4.kerning.keypoints.keysplines.keytimes.lang.lengthadjust.letter-spacing.kernelmatrix.kernelunitlength.lighting-color.local.marker-end.marker-mid.marker-start.markerheight.markerunits.markerwidth.maskcontentunits.maskunits.max.mask.mask-type.media.method.mode.min.name.numoctaves.offset.operator.opacity.order.orient.orientation.origin.overflow.paint-order.path.pathlength.patterncontentunits.patterntransform.patternunits.points.preservealpha.preserveaspectratio.primitiveunits.r.rx.ry.radius.refx.refy.repeatcount.repeatdur.restart.result.rotate.scale.seed.shape-rendering.slope.specularconstant.specularexponent.spreadmethod.startoffset.stddeviation.stitchtiles.stop-color.stop-opacity.stroke-dasharray.stroke-dashoffset.stroke-linecap.stroke-linejoin.stroke-miterlimit.stroke-opacity.stroke.stroke-width.style.surfacescale.systemlanguage.tabindex.tablevalues.targetx.targety.transform.transform-origin.text-anchor.text-decoration.text-rendering.textlength.type.u1.u2.unicode.values.viewbox.visibility.version.vert-adv-y.vert-origin-x.vert-origin-y.width.word-spacing.wrap.writing-mode.xchannelselector.ychannelselector.x.x1.x2.xmlns.y.y1.y2.z.zoomandpan`.split(`.`)),Ce=s(`accent.accentunder.align.bevelled.close.columnalign.columnlines.columnspacing.columnspan.denomalign.depth.dir.display.displaystyle.encoding.fence.frame.height.href.id.largeop.length.linethickness.lquote.lspace.mathbackground.mathcolor.mathsize.mathvariant.maxsize.minsize.movablelimits.notation.numalign.open.rowalign.rowlines.rowspacing.rowspan.rspace.rquote.scriptlevel.scriptminsize.scriptsizemultiplier.selection.separator.separators.stretchy.subscriptshift.supscriptshift.symmetric.voffset.width.xmlns`.split(`.`)),we=s([`xlink:href`,`xml:id`,`xlink:title`,`xml:space`,`xmlns:xlink`]),Te=c(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Ee=c(/<%[\w\W]*|[\w\W]*%>/gm),De=c(/\$\{[\w\W]*/gm),E=c(/^data-[\-\w.\u00B7-\uFFFF]+$/),Oe=c(/^aria-[\-\w]+$/),ke=c(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Ae=c(/^(?:\w+script|data):/i),je=c(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Me=c(/^html$/i),Ne=c(/^[a-z][.\w]*(-[.\w]+)+$/i),Pe=Object.freeze({__proto__:null,ARIA_ATTR:Oe,ATTR_WHITESPACE:je,CUSTOM_ELEMENT:Ne,DATA_ATTR:E,DOCTYPE_NAME:Me,ERB_EXPR:Ee,IS_ALLOWED_URI:ke,IS_SCRIPT_OR_DATA:Ae,MUSTACHE_EXPR:Te,TMPLIT_EXPR:De}),Fe={element:1,text:3,progressingInstruction:7,comment:8,document:9},Ie=function(){return typeof window>`u`?null:window},Le=function(e,t){if(typeof e!=`object`||typeof e.createPolicy!=`function`)return null;let n=null,r=`data-tt-policy-suffix`;t&&t.hasAttribute(r)&&(n=t.getAttribute(r));let i=`dompurify`+(n?`#`+n:``);try{return e.createPolicy(i,{createHTML(e){return e},createScriptURL(e){return e}})}catch{return console.warn(`TrustedTypes policy `+i+` could not be created.`),null}},Re=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function ze(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Ie(),t=e=>ze(e);if(t.version=`3.4.1`,t.removed=[],!e||!e.document||e.document.nodeType!==Fe.document||!e.Element)return t.isSupported=!1,t;let{document:r}=e,i=r,a=i.currentScript,{DocumentFragment:o,HTMLTemplateElement:c,Node:u,Element:d,NodeFilter:ie,NamedNodeMap:ae=e.NamedNodeMap||e.MozNamedAttrMap,HTMLFormElement:oe,DOMParser:se,trustedTypes:ce}=e,S=d.prototype,ue=T(S,`cloneNode`),de=T(S,`remove`),Te=T(S,`nextSibling`),Ee=T(S,`childNodes`),De=T(S,`parentNode`);if(typeof c==`function`){let e=r.createElement(`template`);e.content&&e.content.ownerDocument&&(r=e.content.ownerDocument)}let E,Oe=``,{implementation:Ae,createNodeIterator:je,createDocumentFragment:Ne,getElementsByTagName:D}=r,{importNode:Be}=i,O=Re();t.isSupported=typeof n==`function`&&typeof De==`function`&&Ae&&Ae.createHTMLDocument!==void 0;let{MUSTACHE_EXPR:Ve,ERB_EXPR:He,TMPLIT_EXPR:Ue,DATA_ATTR:We,ARIA_ATTR:Ge,IS_SCRIPT_OR_DATA:Ke,ATTR_WHITESPACE:qe,CUSTOM_ELEMENT:Je}=Pe,{IS_ALLOWED_URI:Ye}=Pe,k=null,Xe=C({},[...me,...he,...ge,...ve,...be]),A=null,Ze=C({},[...xe,...Se,...Ce,...we]),j=Object.seal(l(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),M=null,N=null,Qe=Object.seal(l(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}})),$e=!0,et=!0,tt=!1,nt=!0,rt=!1,it=!0,at=!1,ot=!1,st=!1,ct=!1,lt=!1,ut=!1,dt=!0,ft=!1,pt=`user-content-`,mt=!0,ht=!1,gt={},_t=null,vt=C({},[`annotation-xml`,`audio`,`colgroup`,`desc`,`foreignobject`,`head`,`iframe`,`math`,`mi`,`mn`,`mo`,`ms`,`mtext`,`noembed`,`noframes`,`noscript`,`plaintext`,`script`,`style`,`svg`,`template`,`thead`,`title`,`video`,`xmp`]),yt=null,bt=C({},[`audio`,`video`,`img`,`source`,`image`,`track`]),xt=null,St=C({},[`alt`,`class`,`for`,`id`,`label`,`name`,`pattern`,`placeholder`,`role`,`summary`,`title`,`value`,`style`,`xmlns`]),Ct=`http://www.w3.org/1998/Math/MathML`,wt=`http://www.w3.org/2000/svg`,P=`http://www.w3.org/1999/xhtml`,F=P,Tt=!1,Et=null,Dt=C({},[Ct,wt,P],te),Ot=C({},[`mi`,`mo`,`mn`,`ms`,`mtext`]),kt=C({},[`annotation-xml`]),At=C({},[`title`,`style`,`font`,`a`,`script`]),jt=null,Mt=[`application/xhtml+xml`,`text/html`],I=null,Nt=null,Pt=r.createElement(`form`),Ft=function(e){return e instanceof RegExp||e instanceof Function},It=function(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Nt&&Nt===e)return;(!e||typeof e!=`object`)&&(e={}),e=w(e),jt=Mt.indexOf(e.PARSER_MEDIA_TYPE)===-1?`text/html`:e.PARSER_MEDIA_TYPE,I=jt===`application/xhtml+xml`?te:_,k=b(e,`ALLOWED_TAGS`)&&g(e.ALLOWED_TAGS)?C({},e.ALLOWED_TAGS,I):Xe,A=b(e,`ALLOWED_ATTR`)&&g(e.ALLOWED_ATTR)?C({},e.ALLOWED_ATTR,I):Ze,Et=b(e,`ALLOWED_NAMESPACES`)&&g(e.ALLOWED_NAMESPACES)?C({},e.ALLOWED_NAMESPACES,te):Dt,xt=b(e,`ADD_URI_SAFE_ATTR`)&&g(e.ADD_URI_SAFE_ATTR)?C(w(St),e.ADD_URI_SAFE_ATTR,I):St,yt=b(e,`ADD_DATA_URI_TAGS`)&&g(e.ADD_DATA_URI_TAGS)?C(w(bt),e.ADD_DATA_URI_TAGS,I):bt,_t=b(e,`FORBID_CONTENTS`)&&g(e.FORBID_CONTENTS)?C({},e.FORBID_CONTENTS,I):vt,M=b(e,`FORBID_TAGS`)&&g(e.FORBID_TAGS)?C({},e.FORBID_TAGS,I):w({}),N=b(e,`FORBID_ATTR`)&&g(e.FORBID_ATTR)?C({},e.FORBID_ATTR,I):w({}),gt=b(e,`USE_PROFILES`)?e.USE_PROFILES&&typeof e.USE_PROFILES==`object`?w(e.USE_PROFILES):e.USE_PROFILES:!1,$e=e.ALLOW_ARIA_ATTR!==!1,et=e.ALLOW_DATA_ATTR!==!1,tt=e.ALLOW_UNKNOWN_PROTOCOLS||!1,nt=e.ALLOW_SELF_CLOSE_IN_ATTR!==!1,rt=e.SAFE_FOR_TEMPLATES||!1,it=e.SAFE_FOR_XML!==!1,at=e.WHOLE_DOCUMENT||!1,ct=e.RETURN_DOM||!1,lt=e.RETURN_DOM_FRAGMENT||!1,ut=e.RETURN_TRUSTED_TYPE||!1,st=e.FORCE_BODY||!1,dt=e.SANITIZE_DOM!==!1,ft=e.SANITIZE_NAMED_PROPS||!1,mt=e.KEEP_CONTENT!==!1,ht=e.IN_PLACE||!1,Ye=pe(e.ALLOWED_URI_REGEXP)?e.ALLOWED_URI_REGEXP:ke,F=typeof e.NAMESPACE==`string`?e.NAMESPACE:P,Ot=b(e,`MATHML_TEXT_INTEGRATION_POINTS`)&&e.MATHML_TEXT_INTEGRATION_POINTS&&typeof e.MATHML_TEXT_INTEGRATION_POINTS==`object`?w(e.MATHML_TEXT_INTEGRATION_POINTS):C({},[`mi`,`mo`,`mn`,`ms`,`mtext`]),kt=b(e,`HTML_INTEGRATION_POINTS`)&&e.HTML_INTEGRATION_POINTS&&typeof e.HTML_INTEGRATION_POINTS==`object`?w(e.HTML_INTEGRATION_POINTS):C({},[`annotation-xml`]);let t=b(e,`CUSTOM_ELEMENT_HANDLING`)&&e.CUSTOM_ELEMENT_HANDLING&&typeof e.CUSTOM_ELEMENT_HANDLING==`object`?w(e.CUSTOM_ELEMENT_HANDLING):l(null);if(j=l(null),b(t,`tagNameCheck`)&&Ft(t.tagNameCheck)&&(j.tagNameCheck=t.tagNameCheck),b(t,`attributeNameCheck`)&&Ft(t.attributeNameCheck)&&(j.attributeNameCheck=t.attributeNameCheck),b(t,`allowCustomizedBuiltInElements`)&&typeof t.allowCustomizedBuiltInElements==`boolean`&&(j.allowCustomizedBuiltInElements=t.allowCustomizedBuiltInElements),rt&&(et=!1),lt&&(ct=!0),gt&&(k=C({},be),A=l(null),gt.html===!0&&(C(k,me),C(A,xe)),gt.svg===!0&&(C(k,he),C(A,Se),C(A,we)),gt.svgFilters===!0&&(C(k,ge),C(A,Se),C(A,we)),gt.mathMl===!0&&(C(k,ve),C(A,Ce),C(A,we))),Qe.tagCheck=null,Qe.attributeCheck=null,b(e,`ADD_TAGS`)&&(typeof e.ADD_TAGS==`function`?Qe.tagCheck=e.ADD_TAGS:g(e.ADD_TAGS)&&(k===Xe&&(k=w(k)),C(k,e.ADD_TAGS,I))),b(e,`ADD_ATTR`)&&(typeof e.ADD_ATTR==`function`?Qe.attributeCheck=e.ADD_ATTR:g(e.ADD_ATTR)&&(A===Ze&&(A=w(A)),C(A,e.ADD_ATTR,I))),b(e,`ADD_URI_SAFE_ATTR`)&&g(e.ADD_URI_SAFE_ATTR)&&C(xt,e.ADD_URI_SAFE_ATTR,I),b(e,`FORBID_CONTENTS`)&&g(e.FORBID_CONTENTS)&&(_t===vt&&(_t=w(_t)),C(_t,e.FORBID_CONTENTS,I)),b(e,`ADD_FORBID_CONTENTS`)&&g(e.ADD_FORBID_CONTENTS)&&(_t===vt&&(_t=w(_t)),C(_t,e.ADD_FORBID_CONTENTS,I)),mt&&(k[`#text`]=!0),at&&C(k,[`html`,`head`,`body`]),k.table&&(C(k,[`tbody`]),delete M.tbody),e.TRUSTED_TYPES_POLICY){if(typeof e.TRUSTED_TYPES_POLICY.createHTML!=`function`)throw le(`TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.`);if(typeof e.TRUSTED_TYPES_POLICY.createScriptURL!=`function`)throw le(`TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.`);E=e.TRUSTED_TYPES_POLICY,Oe=E.createHTML(``)}else E===void 0&&(E=Le(ce,a)),E!==null&&typeof Oe==`string`&&(Oe=E.createHTML(``));s&&s(e),Nt=e},Lt=C({},[...he,...ge,..._e]),Rt=C({},[...ve,...ye]),zt=function(e){let t=De(e);(!t||!t.tagName)&&(t={namespaceURI:F,tagName:`template`});let n=_(e.tagName),r=_(t.tagName);return Et[e.namespaceURI]?e.namespaceURI===wt?t.namespaceURI===P?n===`svg`:t.namespaceURI===Ct?n===`svg`&&(r===`annotation-xml`||Ot[r]):!!Lt[n]:e.namespaceURI===Ct?t.namespaceURI===P?n===`math`:t.namespaceURI===wt?n===`math`&&kt[r]:!!Rt[n]:e.namespaceURI===P?t.namespaceURI===wt&&!kt[r]||t.namespaceURI===Ct&&!Ot[r]?!1:!Rt[n]&&(At[n]||!Lt[n]):!!(jt===`application/xhtml+xml`&&Et[e.namespaceURI]):!1},Bt=function(e){h(t.removed,{element:e});try{De(e).removeChild(e)}catch{de(e)}},L=function(e,n){try{h(t.removed,{attribute:n.getAttributeNode(e),from:n})}catch{h(t.removed,{attribute:null,from:n})}if(n.removeAttribute(e),e===`is`)if(ct||lt)try{Bt(n)}catch{}else try{n.setAttribute(e,``)}catch{}},Vt=function(e){let t=null,n=null;if(st)e=`<remove></remove>`+e;else{let t=v(e,/^[\r\n\t ]+/);n=t&&t[0]}jt===`application/xhtml+xml`&&F===P&&(e=`<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>`+e+`</body></html>`);let i=E?E.createHTML(e):e;if(F===P)try{t=new se().parseFromString(i,jt)}catch{}if(!t||!t.documentElement){t=Ae.createDocument(F,`template`,null);try{t.documentElement.innerHTML=Tt?Oe:i}catch{}}let a=t.body||t.documentElement;return e&&n&&a.insertBefore(r.createTextNode(n),a.childNodes[0]||null),F===P?D.call(t,at?`html`:`body`)[0]:at?t.documentElement:a},Ht=function(e){return je.call(e.ownerDocument||e,e,ie.SHOW_ELEMENT|ie.SHOW_COMMENT|ie.SHOW_TEXT|ie.SHOW_PROCESSING_INSTRUCTION|ie.SHOW_CDATA_SECTION,null)},Ut=function(e){return e instanceof oe&&(typeof e.nodeName!=`string`||typeof e.textContent!=`string`||typeof e.removeChild!=`function`||!(e.attributes instanceof ae)||typeof e.removeAttribute!=`function`||typeof e.setAttribute!=`function`||typeof e.namespaceURI!=`string`||typeof e.insertBefore!=`function`||typeof e.hasChildNodes!=`function`)},Wt=function(e){return typeof u==`function`&&e instanceof u};function R(e,n,r){f(e,e=>{e.call(t,n,r,Nt)})}let Gt=function(e){let n=null;if(R(O.beforeSanitizeElements,e,null),Ut(e))return Bt(e),!0;let r=I(e.nodeName);if(R(O.uponSanitizeElement,e,{tagName:r,allowedTags:k}),it&&e.hasChildNodes()&&!Wt(e.firstElementChild)&&x(/<[/\w!]/g,e.innerHTML)&&x(/<[/\w!]/g,e.textContent)||it&&e.namespaceURI===P&&r===`style`&&Wt(e.firstElementChild)||e.nodeType===Fe.progressingInstruction||it&&e.nodeType===Fe.comment&&x(/<[/\w]/g,e.data))return Bt(e),!0;if(M[r]||!(Qe.tagCheck instanceof Function&&Qe.tagCheck(r))&&!k[r]){if(!M[r]&&Jt(r)&&(j.tagNameCheck instanceof RegExp&&x(j.tagNameCheck,r)||j.tagNameCheck instanceof Function&&j.tagNameCheck(r)))return!1;if(mt&&!_t[r]){let t=De(e)||e.parentNode,n=Ee(e)||e.childNodes;if(n&&t){let r=n.length;for(let i=r-1;i>=0;--i){let r=ue(n[i],!0);t.insertBefore(r,Te(e))}}}return Bt(e),!0}return e instanceof d&&!zt(e)||(r===`noscript`||r===`noembed`||r===`noframes`)&&x(/<\/no(script|embed|frames)/i,e.innerHTML)?(Bt(e),!0):(rt&&e.nodeType===Fe.text&&(n=e.textContent,f([Ve,He,Ue],e=>{n=y(n,e,` `)}),e.textContent!==n&&(h(t.removed,{element:e.cloneNode()}),e.textContent=n)),R(O.afterSanitizeElements,e,null),!1)},Kt=function(e,t,n){if(N[t]||dt&&(t===`id`||t===`name`)&&(n in r||n in Pt))return!1;if(!(et&&!N[t]&&x(We,t))&&!($e&&x(Ge,t))&&!(Qe.attributeCheck instanceof Function&&Qe.attributeCheck(t,e))){if(!A[t]||N[t]){if(!(Jt(e)&&(j.tagNameCheck instanceof RegExp&&x(j.tagNameCheck,e)||j.tagNameCheck instanceof Function&&j.tagNameCheck(e))&&(j.attributeNameCheck instanceof RegExp&&x(j.attributeNameCheck,t)||j.attributeNameCheck instanceof Function&&j.attributeNameCheck(t,e))||t===`is`&&j.allowCustomizedBuiltInElements&&(j.tagNameCheck instanceof RegExp&&x(j.tagNameCheck,n)||j.tagNameCheck instanceof Function&&j.tagNameCheck(n))))return!1}else if(!xt[t]&&!x(Ye,y(n,qe,``))&&!((t===`src`||t===`xlink:href`||t===`href`)&&e!==`script`&&ne(n,`data:`)===0&&yt[e])&&!(tt&&!x(Ke,y(n,qe,``)))&&n)return!1}return!0},qt=C({},[`annotation-xml`,`color-profile`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`missing-glyph`]),Jt=function(e){return!qt[_(e)]&&x(Je,e)},Yt=function(e){R(O.beforeSanitizeAttributes,e,null);let{attributes:n}=e;if(!n||Ut(e))return;let r={attrName:``,attrValue:``,keepAttr:!0,allowedAttributes:A,forceKeepAttr:void 0},i=n.length;for(;i--;){let{name:a,namespaceURI:o,value:s}=n[i],c=I(a),l=s,u=a===`value`?l:re(l);if(r.attrName=c,r.attrValue=u,r.keepAttr=!0,r.forceKeepAttr=void 0,R(O.uponSanitizeAttribute,e,r),u=r.attrValue,ft&&(c===`id`||c===`name`)&&ne(u,pt)!==0&&(L(a,e),u=pt+u),it&&x(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,u)){L(a,e);continue}if(c===`attributename`&&v(u,`href`)){L(a,e);continue}if(r.forceKeepAttr)continue;if(!r.keepAttr){L(a,e);continue}if(!nt&&x(/\/>/i,u)){L(a,e);continue}rt&&f([Ve,He,Ue],e=>{u=y(u,e,` `)});let d=I(e.nodeName);if(!Kt(d,c,u)){L(a,e);continue}if(E&&typeof ce==`object`&&typeof ce.getAttributeType==`function`&&!o)switch(ce.getAttributeType(d,c)){case`TrustedHTML`:u=E.createHTML(u);break;case`TrustedScriptURL`:u=E.createScriptURL(u);break}if(u!==l)try{o?e.setAttributeNS(o,a,u):e.setAttribute(a,u),Ut(e)?Bt(e):m(t.removed)}catch{L(a,e)}}R(O.afterSanitizeAttributes,e,null)},Xt=function(e){let t=null,n=Ht(e);for(R(O.beforeSanitizeShadowDOM,e,null);t=n.nextNode();)R(O.uponSanitizeShadowNode,t,null),Gt(t),Yt(t),t.content instanceof o&&Xt(t.content);R(O.afterSanitizeShadowDOM,e,null)};return t.sanitize=function(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},r=null,a=null,s=null,c=null;if(Tt=!e,Tt&&(e=`<!-->`),typeof e!=`string`&&!Wt(e)&&(e=fe(e),typeof e!=`string`))throw le(`dirty is not a string, aborting`);if(!t.isSupported)return e;if(ot||It(n),t.removed=[],typeof e==`string`&&(ht=!1),ht){let t=e.nodeName;if(typeof t==`string`){let e=I(t);if(!k[e]||M[e])throw le(`root node is forbidden and cannot be sanitized in-place`)}}else if(e instanceof u)r=Vt(`<!---->`),a=r.ownerDocument.importNode(e,!0),a.nodeType===Fe.element&&a.nodeName===`BODY`||a.nodeName===`HTML`?r=a:r.appendChild(a);else{if(!ct&&!rt&&!at&&e.indexOf(`<`)===-1)return E&&ut?E.createHTML(e):e;if(r=Vt(e),!r)return ct?null:ut?Oe:``}r&&st&&Bt(r.firstChild);let l=Ht(ht?e:r);for(;s=l.nextNode();)Gt(s),Yt(s),s.content instanceof o&&Xt(s.content);if(ht)return e;if(ct){if(rt){r.normalize();let e=r.innerHTML;f([Ve,He,Ue],t=>{e=y(e,t,` `)}),r.innerHTML=e}if(lt)for(c=Ne.call(r.ownerDocument);r.firstChild;)c.appendChild(r.firstChild);else c=r;return(A.shadowroot||A.shadowrootmode)&&(c=Be.call(i,c,!0)),c}let d=at?r.outerHTML:r.innerHTML;return at&&k[`!doctype`]&&r.ownerDocument&&r.ownerDocument.doctype&&r.ownerDocument.doctype.name&&x(Me,r.ownerDocument.doctype.name)&&(d=`<!DOCTYPE `+r.ownerDocument.doctype.name+`>
`+d),rt&&f([Ve,He,Ue],e=>{d=y(d,e,` `)}),E&&ut?E.createHTML(d):d},t.setConfig=function(){It(arguments.length>0&&arguments[0]!==void 0?arguments[0]:{}),ot=!0},t.clearConfig=function(){Nt=null,ot=!1},t.isValidAttribute=function(e,t,n){return Nt||It({}),Kt(I(e),I(t),n)},t.addHook=function(e,t){typeof t==`function`&&h(O[e],t)},t.removeHook=function(e,t){if(t!==void 0){let n=p(O[e],t);return n===-1?void 0:ee(O[e],n,1)[0]}return m(O[e])},t.removeHooks=function(e){O[e]=[]},t.removeAllHooks=function(){O=Re()},t}var D=ze(),Be=`poa-user-id`,O=`poa-user-name`,Ve=`poa-role`;function He(){return typeof crypto<`u`&&typeof crypto.randomUUID==`function`?crypto.randomUUID().replace(/-/g,``).slice(0,16):Array.from({length:16},()=>Math.floor(Math.random()*16).toString(16)).join(``)}function Ue(){let e=localStorage.getItem(Be);return e||(e=He(),localStorage.setItem(Be,e)),e}function We(){return localStorage.getItem(O)??`사용자`}function Ge(e){localStorage.setItem(O,e.trim()||`사용자`)}function Ke(e){localStorage.setItem(Ve,e)}function qe(){let e=new URLSearchParams(window.location.search).get(`role`);e?Ke(e):localStorage.removeItem(Ve)}var Je=class{execute(e){e.execute()}undo(){}redo(){}},Ye=class{name;constructor(e){this.name=e}},k=class extends Ye{tag;savedRange;ownerDocument;lastActionWasWrap=!1;wrappedElement=null;movedChildren=null;movedChildrenParent=null;movedChildrenAnchor=null;constructor(e,t,n){super(`format:${e}`),this.tag=e,this.savedRange=t.cloneRange(),this.ownerDocument=n}execute(){let e=this.savedRange.cloneRange();if(e.collapsed)return;let t=this.ownerDocument.getSelection();this.isTagActive(e)?(this.lastActionWasWrap=!1,this.removeFormat(e,t)):(this.lastActionWasWrap=!0,this.applyFormat(e,t))}undo(){this.lastActionWasWrap?this.undoWrap():this.undoRemove()}isTagActive(e){return this.findAncestor(e.commonAncestorContainer,this.tag)!==null}applyFormat(e,t){let n=this.ownerDocument.createElement(this.tag);try{let r=e.extractContents();if(n.appendChild(r),e.insertNode(n),this.wrappedElement=n,t){t.removeAllRanges();let e=this.ownerDocument.createRange();e.selectNodeContents(n),t.addRange(e)}}catch{}}removeFormat(e,t){let n=this.findAncestor(e.commonAncestorContainer,this.tag);if(!n||!n.parentNode)return;let r=n.parentNode,i=Array.from(n.childNodes),a=n.nextSibling;if(i.forEach(e=>r.insertBefore(e,n)),r.removeChild(n),this.movedChildren=i,this.movedChildrenParent=r,this.movedChildrenAnchor=a,t&&i.length>0){t.removeAllRanges();let e=this.ownerDocument.createRange();e.setStartBefore(i[0]),e.setEndAfter(i[i.length-1]),t.addRange(e)}}undoWrap(){if(!this.wrappedElement||!this.wrappedElement.parentNode)return;let e=this.wrappedElement.parentNode;Array.from(this.wrappedElement.childNodes).forEach(t=>e.insertBefore(t,this.wrappedElement)),e.removeChild(this.wrappedElement),this.wrappedElement=null}undoRemove(){if(!this.movedChildren||!this.movedChildrenParent)return;let e=this.ownerDocument.createElement(this.tag);this.movedChildren.forEach(t=>e.appendChild(t)),this.movedChildrenParent.insertBefore(e,this.movedChildrenAnchor),this.movedChildren=null,this.movedChildrenParent=null,this.movedChildrenAnchor=null}findAncestor(e,t){let n=e;for(;n;){if(n.nodeType===1&&n.tagName.toLowerCase()===t.toLowerCase())return n;n=n.parentNode}return null}},Xe=class{static async serialize(e){let t=new TextEncoder().encode(e);if(typeof CompressionStream>`u`)return t;let n=new CompressionStream(`gzip`),r=n.writable.getWriter();r.write(t).then(()=>r.close());let i=await new Response(n.readable).arrayBuffer();return new Uint8Array(i)}static async deserialize(e){if(!(e.length>=2&&e[0]===31&&e[1]===139)||typeof DecompressionStream>`u`)return new TextDecoder().decode(e);let t=new DecompressionStream(`gzip`),n=t.writable.getWriter();n.write(new Uint8Array(e)).then(()=>n.close());let r=await new Response(t.readable).arrayBuffer();return new TextDecoder().decode(r)}},A=class{entries=[];pointer=-1;maxSize=100;setInitial(e){let t=new TextEncoder().encode(e);this.entries=[{data:t,label:`initial`,isCheckpoint:!1}],this.pointer=0}async push(e,t,n=!1){this.entries.splice(this.pointer+1);let r=await Xe.serialize(e);this.entries.push({data:r,label:t,isCheckpoint:n}),this.pointer++,this.entries.length>this.maxSize+1&&(this.entries.shift(),this.pointer--)}async undo(){return this.canUndo()?(this.pointer--,Xe.deserialize(this.entries[this.pointer].data)):null}async redo(){return this.canRedo()?(this.pointer++,Xe.deserialize(this.entries[this.pointer].data)):null}canUndo(){return this.pointer>0}canRedo(){return this.pointer>=0&&this.pointer<this.entries.length-1}isInitialized(){return this.pointer>=0}getStackSize(){return this.entries.length}getCurrentLabel(){return this.pointer<0?null:this.entries[this.pointer].label}},Ze=class{config;commandManager;historyManager;root=null;inputTimer=null;inputHandler=()=>{this.inputTimer!==null&&clearTimeout(this.inputTimer),this.inputTimer=setTimeout(()=>{this.inputTimer=null,this.root&&this.historyManager.push(this.root.innerHTML,`input`).then(()=>{this.config.onHistoryPush?.()})},800)};keydownHandler=async e=>{(e.ctrlKey||e.metaKey)&&(e.key===`z`&&!e.shiftKey?(e.preventDefault(),await this.undo()):e.key===`y`||e.key===`z`&&e.shiftKey?(e.preventDefault(),await this.redo()):e.key===`b`?(e.preventDefault(),await this.bold()):e.key===`i`?(e.preventDefault(),await this.italic()):e.key===`u`&&(e.preventDefault(),await this.underline()))};constructor(e={}){this.config=e,this.commandManager=new Je,this.historyManager=new A}mount(e){this.root=e,e.contentEditable=this.config.readonly?`false`:`true`,e.setAttribute(`role`,`textbox`),e.setAttribute(`aria-multiline`,`true`),this.config.placeholder&&(e.dataset.placeholder=this.config.placeholder),this.historyManager.setInitial(e.innerHTML),e.addEventListener(`input`,this.inputHandler),e.addEventListener(`keydown`,this.keydownHandler)}unmount(){this.root&&=(this.inputTimer!==null&&(clearTimeout(this.inputTimer),this.inputTimer=null),this.root.removeEventListener(`input`,this.inputHandler),this.root.removeEventListener(`keydown`,this.keydownHandler),this.root.contentEditable=`inherit`,this.root.removeAttribute(`role`),this.root.removeAttribute(`aria-multiline`),delete this.root.dataset.placeholder,null)}async execute(e){if(!this.root)throw Error(`EditorCore가 마운트되지 않았습니다.`);await this.flushInput(),this.commandManager.execute(e),await this.historyManager.push(this.root.innerHTML,e.name)}async undo(){if(!this.root)return;await this.flushInput();let e=await this.historyManager.undo();e!==null&&(this.root.innerHTML=D.sanitize(e))}async redo(){if(!this.root)return;let e=await this.historyManager.redo();e!==null&&(this.root.innerHTML=D.sanitize(e))}async flushInput(){this.inputTimer!==null&&(clearTimeout(this.inputTimer),this.inputTimer=null,this.root&&await this.historyManager.push(this.root.innerHTML,`input`))}async captureHistory(e){this.root&&await this.historyManager.push(this.root.innerHTML,e)}canUndo(){return this.historyManager.canUndo()}canRedo(){return this.historyManager.canRedo()}async bold(){await this.applyFormat(`strong`)}async italic(){await this.applyFormat(`em`)}async underline(){await this.applyFormat(`u`)}async applyFormatWithRange(e,t){if(!this.root)throw Error(`EditorCore가 마운트되지 않았습니다.`);let n=new k(e,t,this.root.ownerDocument);await this.execute(n)}async strike(){await this.applyFormat(`s`)}isMounted(){return this.root!==null}async applyFormat(e){if(!this.root)throw Error(`EditorCore가 마운트되지 않았습니다.`);let t=this.root.ownerDocument,n=t.getSelection();if(!n||n.rangeCount===0)return;let r=new k(e,n.getRangeAt(0),t);await this.execute(r)}},j={bold:`strong`,italic:`em`,underline:`u`,strike:`s`},M=new class{listeners=new Map;on(e,t){this.listeners.has(e)||this.listeners.set(e,new Set),this.listeners.get(e).add(t)}off(e,t){this.listeners.get(e)?.delete(t)}emit(e,t){this.listeners.get(e)?.forEach(e=>e(t))}},N={FILE_NEW:`file:new`,FILE_OPENED:`file:opened`,FILE_SAVED:`file:saved`,FILE_DIRTY:`file:dirty`,AUTOSAVE_SAVED:`autosave:saved`,AUTOSAVE_RESTORED:`autosave:restored`,MENUBAR_CHANGE:`menubar:change`,VIEW_CHANGE:`view:change`,SETTINGS_CHANGED:`settings:changed`,PAGE_UPDATED:`page:updated`,DOC_TITLE_CHANGE:`doc:title-change`};function Qe(e){return D.sanitize(e,{USE_PROFILES:{html:!0},FORBID_TAGS:[`script`,`object`,`embed`],FORBID_ATTR:[`onerror`,`onload`,`onclick`,`onmouseover`,`onfocus`,`onblur`]})}function $e(e){return new DOMParser().parseFromString(e,`text/html`).body.textContent??``}function et(e){return e.split(`
`).map(e=>{let t=e.trim();return t===``?`<br>`:`<p>${tt(t)}</p>`}).join(``)}function tt(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function nt(e){e.querySelectorAll(`input`).forEach(e=>{e.setAttribute(`value`,e.value)}),e.querySelectorAll(`textarea`).forEach(e=>{e.textContent=e.value}),e.querySelectorAll(`select`).forEach(e=>{let t=e.selectedIndex;Array.from(e.options).forEach((e,n)=>{n===t?e.setAttribute(`selected`,`selected`):e.removeAttribute(`selected`)})})}function rt(e){return e.nodeType===Node.ELEMENT_NODE}var it=new Set([`P`,`DIV`,`H1`,`H2`,`H3`,`H4`,`H5`,`H6`,`LI`,`BLOCKQUOTE`,`PRE`,`FIGURE`,`TD`,`TH`]);function at(e){return rt(e)&&it.has(e.tagName)}function ot(e,t){let n=e;for(;n&&n!==t;){if(at(n))return n;n=n.parentNode}return null}function st(e,t){if(t.collapsed){let n=ot(t.startContainer,e);if(n)return[n];if(t.startContainer===e){let n=e.childNodes[t.startOffset],r=e.childNodes[t.startOffset-1];if(n&&at(n))return[n];if(r&&at(r))return[r]}return[]}let n=t.commonAncestorContainer;if(n!==e&&!n.contains(e)){let t=ot(n,e);if(t)return[t]}let r=[];for(let n of Array.from(e.childNodes))at(n)&&t.intersectsNode(n)&&r.push(n);if(r.length>0)return r;let i=ot(t.startContainer,e);return i?[i]:[]}function ct(e){let t=e.style.float||getComputedStyle(e).float;if(t===`left`)return`left`;if(t===`right`)return`right`;let n=e.style.marginLeft||getComputedStyle(e).marginLeft,r=e.style.marginRight||getComputedStyle(e).marginRight;return n===`auto`&&r===`auto`?`center`:`left`}function lt(e){let t=e.style.marginLeft||getComputedStyle(e).marginLeft,n=e.style.marginRight||getComputedStyle(e).marginRight;return t===`auto`&&n===`auto`?`center`:t===`auto`&&n!==`auto`?`right`:`left`}var ut=new Set([`image/png`,`image/jpeg`,`image/gif`,`image/webp`,`image/bmp`]);function dt(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function ft(e){return e.split(`
`).map(e=>{let t=e.trim();return t===``?`<br>`:`<p>${dt(t)}</p>`}).join(``)}function pt(e){return D.sanitize(e,{USE_PROFILES:{html:!0},ADD_ATTR:[`style`,`border`,`width`,`height`,`colspan`,`rowspan`,`cellpadding`,`cellspacing`,`align`,`valign`,`bgcolor`,`nowrap`],ADD_TAGS:[`table`,`tr`,`td`,`th`,`thead`,`tbody`,`tfoot`,`colgroup`,`col`]})}function mt(e){e.querySelectorAll(`tr`).forEach(e=>{let t=e.getAttribute(`style`)??``,n={};t.split(`;`).forEach(e=>{let t=e.indexOf(`:`);if(t<0)return;let r=e.slice(0,t).trim().toLowerCase(),i=e.slice(t+1).trim();r&&(n[r]=i)}),!n.height&&n[`mso-row-height`]&&(e.style.height=n[`mso-row-height`],n.height=n[`mso-row-height`]);let r=e.getAttribute(`height`);r&&!n.height&&!e.style.height&&(e.style.height=`${r}px`,n.height=`${r}px`),n[`mso-height-rule`]?.toLowerCase()===`exactly`&&n.height&&Array.from(e.cells).forEach(e=>{e.style.height||(e.style.height=n.height)})})}function ht(e){e.querySelectorAll(`[style]`).forEach(e=>{let t=(e.getAttribute(`style`)??``).split(`;`).map(e=>e.trim()).filter(e=>e.length>0&&!e.toLowerCase().startsWith(`mso-`)).join(`; `);t?e.setAttribute(`style`,t):e.removeAttribute(`style`)})}function gt(e){e.querySelectorAll(`td > p, th > p, td p, th p`).forEach(e=>{e.style.margin||(e.style.margin=`0`),e.style.lineHeight||(e.style.lineHeight=`1.2`)})}function _t(e){let t=new DOMParser().parseFromString(e,`text/html`);return mt(t),ht(t),gt(t),t.querySelectorAll(`table`).forEach(e=>{e.style.borderCollapse=`collapse`,e.style.width||(e.style.width=`100%`),!e.style.border&&!e.getAttribute(`border`)&&(e.style.border=`1px solid #000000`),e.removeAttribute(`width`),e.removeAttribute(`height`),e.style.maxWidth=`100%`}),t.querySelectorAll(`td, th`).forEach(e=>{!e.style.border&&!e.style.borderTop&&(e.style.border=`1px solid #000000`),e.style.padding||(e.style.padding=`2px 4px`),e.style.wordBreak||(e.style.wordBreak=`break-word`)}),t.body.innerHTML}function vt(e){return e.includes(`xmlns:x="urn:schemas-microsoft-com:office:excel"`)||e.includes(`mso-number-format`)||e.includes(`x:str`)}function yt(e){let t=new DOMParser().parseFromString(e,`text/html`);t.querySelectorAll(`[class^="xl"]`).forEach(e=>{e.removeAttribute(`class`)}),mt(t),ht(t),gt(t),t.querySelectorAll(`td, th`).forEach(e=>{!e.style.border&&!e.style.borderTop&&(e.style.border=`1px solid #000000`),e.style.padding||(e.style.padding=`2px 4px`)}),t.querySelectorAll(`table`).forEach(e=>{e.setAttribute(`border`,`1`),e.style.borderCollapse=`collapse`,e.style.width||(e.style.width=`100%`),e.removeAttribute(`width`),e.style.maxWidth=`100%`});let n=t.querySelector(`table`);return n?pt(n.outerHTML):``}var bt=class{root;options;pasteHandler=e=>{let t=e.clipboardData;if(!t)return;let n=t.getData(`text/html`);if(n){e.preventDefault();let t;if(t=vt(n)?yt(n):n.includes(`<table`)?pt(_t(n)):Qe(n),!t)return;this.insertAtCursor(t),this.options.onPaste?.(t);return}let r=t.getData(`text/plain`);if(r){e.preventDefault();let t=ft(r);if(!t)return;this.insertAtCursor(t),this.options.onPaste?.(t);return}let i=Array.from(t.items).find(e=>ut.has(e.type));if(i){e.preventDefault();let t=i.getAsFile();if(!t)return;let n=new FileReader;n.onload=e=>{let t=e.target?.result;if(!t)return;let n=this.root.ownerDocument,r=n.createElement(`img`);r.src=t,r.style.maxWidth=`100%`,r.alt=`붙여넣기 이미지`;let i=n.getSelection();if(i&&i.rangeCount>0){let e=i.getRangeAt(0);e.deleteContents(),e.insertNode(r),e.setStartAfter(r),e.collapse(!0),i.removeAllRanges(),i.addRange(e)}else this.root.appendChild(r);this.options.onPasteImage?.()},n.readAsDataURL(t)}};constructor(e,t={}){this.root=e,this.options=t}register(){this.root.addEventListener(`paste`,this.pasteHandler)}unregister(){this.root.removeEventListener(`paste`,this.pasteHandler)}insertAtCursor(e){let t=this.root.ownerDocument.getSelection();if(!t||t.rangeCount===0)return;let n=t.getRangeAt(0);n.deleteContents();let r=n.createContextualFragment(e),i=r.lastChild;n.insertNode(r),i&&(n.setStartAfter(i),n.collapse(!0),t.removeAllRanges(),t.addRange(n))}},xt=class{root;marks=[];currentIndex=-1;constructor(e){this.root=e}find(e,t={}){if(this.clearMarks(),!e.trim())return{count:0,current:-1};let n=this.buildRegex(e,t),r=this.collectTextNodes();for(let e=r.length-1;e>=0;e--){let t=r[e],i=t.nodeValue??``,a=[],o;for(;(o=n.exec(i))!==null;)a.push([o.index,o.index+o[0].length]);for(let e=a.length-1;e>=0;e--){let n=this.wrapRange(t,a[e][0],a[e][1]);n&&this.marks.unshift(n)}}return this.marks.length>0&&(this.currentIndex=0,this.applyHighlight()),{count:this.marks.length,current:this.marks.length>0?0:-1}}next(){return this.marks.length===0?{count:0,current:-1}:(this.currentIndex=(this.currentIndex+1)%this.marks.length,this.applyHighlight(),{count:this.marks.length,current:this.currentIndex})}prev(){return this.marks.length===0?{count:0,current:-1}:(this.currentIndex=(this.currentIndex-1+this.marks.length)%this.marks.length,this.applyHighlight(),{count:this.marks.length,current:this.currentIndex})}replaceCurrent(e){return this.marks.length===0||this.currentIndex<0?{count:0,current:-1}:(this.marks[this.currentIndex].replaceWith(this.root.ownerDocument.createTextNode(e)),this.marks.splice(this.currentIndex,1),this.marks.length===0?(this.currentIndex=-1,{count:0,current:-1,replaced:!0}):(this.currentIndex=Math.min(this.currentIndex,this.marks.length-1),this.applyHighlight(),{count:this.marks.length,current:this.currentIndex,replaced:!0}))}replaceAll(e,t,n={}){this.find(e,n);let r=this.marks.length,i=this.root.ownerDocument;for(let e of this.marks)e.replaceWith(i.createTextNode(t));return this.marks=[],this.currentIndex=-1,r}clearMarks(){for(let e of this.marks){if(!e.parentNode)continue;let t=e.ownerDocument.createDocumentFragment();for(;e.firstChild;)t.appendChild(e.firstChild);e.parentNode.replaceChild(t,e)}this.marks=[],this.currentIndex=-1}buildRegex(e,t){let n=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),r=t.wholeWord?`\\b${n}\\b`:n;return new RegExp(r,t.caseSensitive?`g`:`gi`)}collectTextNodes(){let e=[],t=this.root.ownerDocument.createTreeWalker(this.root,NodeFilter.SHOW_TEXT),n;for(;(n=t.nextNode())!==null;)n.nodeValue?.trim()&&e.push(n);return e}wrapRange(e,t,n){try{let r=e.ownerDocument,i=r.createRange();i.setStart(e,t),i.setEnd(e,n);let a=r.createElement(`mark`);return a.dataset.poaMark=`true`,i.surroundContents(a),a}catch{return null}}applyHighlight(){this.marks.forEach((e,t)=>{let n=t===this.currentIndex;e.style.background=n?`#F59E0B`:`#FEF3C7`,e.style.color=n?`#FFFFFF`:``,e.style.outline=``}),this.marks[this.currentIndex]?.scrollIntoView?.({block:`nearest`,behavior:`smooth`})}},St=new Set([`jpg`,`jpeg`,`png`,`gif`,`webp`,`svg`]),Ct=class{root;savedRange=null;constructor(e){this.root=e}saveSelection(){let e=this.root.ownerDocument.getSelection();e&&e.rangeCount>0&&(this.savedRange=e.getRangeAt(0).cloneRange())}insertFromUrl(e){if(!e.alt.trim())throw Error(`alt 텍스트는 필수입니다. 접근성을 위해 이미지 설명을 입력하세요.`);let t=this.buildImg(e);this.insertNode(t)}async uploadAndInsert(e,t,n){this.validateExtension(e.name);let r=await this.doUpload(e,n);this.insertFromUrl({...t,src:r})}validateExtension(e){let t=e.split(`.`).pop()?.toLowerCase()??``;if(!St.has(t))throw Error(`지원하지 않는 파일 형식입니다. (허용: ${[...St].join(`, `)})`)}async doUpload(e,t){let n=new FormData;n.append(t.fieldName??`file`,e);let r=await fetch(t.uploadUrl,{method:`POST`,headers:t.headers,body:n});if(!r.ok)throw Error(`업로드 실패: HTTP ${r.status}`);let i=await r.json();if(!i.url)throw Error(`서버에서 URL을 반환하지 않았습니다.`);return i.url}buildImg(e){let t=this.root.ownerDocument.createElement(`img`);return t.src=e.src,t.alt=e.alt,e.title&&(t.title=e.title),e.width&&(t.style.width=e.width),e.height&&(t.style.height=e.height),e.border&&(t.style.border=e.border),(e.align===`left`||e.align===`right`)&&(t.style.float=e.align),e.id&&(t.id=e.id),e.className&&(t.className=e.className),t}insertNode(e){let t=this.root.ownerDocument,n=t.getSelection(),r;this.savedRange?(r=this.savedRange.cloneRange(),this.savedRange=null):n&&n.rangeCount>0?r=n.getRangeAt(0):(r=t.createRange(),r.selectNodeContents(this.root),r.collapse(!1)),r.deleteContents(),r.insertNode(e),r.setStartAfter(e),r.collapse(!0),n?.removeAllRanges(),n?.addRange(r)}},wt=`http://192.168.50.120:8080/api/v1`;async function P(e,t){let n=await fetch(`${wt}${e}`,{...t,headers:{"Content-Type":`application/json`,"Poa-User-Id":Ue(),...t?.headers??{}}});if(n.status===204)return;let r=await n.json();if(!r.success)throw Error(r.message??`API 오류`);return r.data}var F={async getDocuments(){return P(`/documents`)},async getDocument(e){return P(`/documents/${e}`)},async createDocument(e,t){return P(`/documents`,{method:`POST`,body:JSON.stringify({title:e,content:t})})},async updateDocument(e,t,n){return P(`/documents/${e}`,{method:`PUT`,body:JSON.stringify({title:t,content:n})})},async deleteDocument(e){await P(`/documents/${e}`,{method:`DELETE`})}},Tt=[{description:`HTML 파일`,accept:{"text/html":[`.html`,`.htm`]}}],Et=[{description:`HTML 파일`,accept:{"text/html":[`.html`,`.htm`]}},{description:`텍스트 파일`,accept:{"text/plain":[`.txt`]}}],Dt=class{fileHandle=null;dirty=!1;currentName=`새 문서`;currentDocKey=null;currentDocTitle=`새 문서`;beforeUnloadHandler=e=>{this.dirty&&(e.preventDefault(),e.returnValue=``)};constructor(){window.addEventListener(`beforeunload`,this.beforeUnloadHandler)}destroy(){window.removeEventListener(`beforeunload`,this.beforeUnloadHandler)}isDirty(){return this.dirty}markDirty(){this.dirty=!0,M.emit(N.FILE_DIRTY,!0),this._emitTitleChange()}markClean(){this.dirty=!1,M.emit(N.FILE_DIRTY,!1),this._emitTitleChange()}getCurrentName(){return this.currentName}getCurrentDocKey(){return this.currentDocKey}getCurrentDocTitle(){return this.currentDocTitle}_emitTitleChange(){M.emit(N.DOC_TITLE_CHANGE,{title:this.currentDocTitle,dirty:this.dirty})}hasFileSystemAccess(){return typeof window<`u`&&`showOpenFilePicker`in window}newDocument(){this.fileHandle=null,this.currentName=`새 문서`,this.currentDocKey=null,this.currentDocTitle=`새 문서`,this.markClean(),M.emit(N.FILE_NEW,void 0)}async saveDocument(e,t){if(this.currentDocKey){let t=await F.updateDocument(this.currentDocKey,this.currentDocTitle,e);return this.markClean(),t}let n=await t();if(n===null)return null;let r=await F.createDocument(n,e);return this.currentDocKey=r.docKey,this.currentDocTitle=r.title,this.markClean(),r}async saveAsDocument(e,t){let n=await t();if(n===null)return null;let r=await F.createDocument(n,e);return this.currentDocKey=r.docKey,this.currentDocTitle=r.title,this.markClean(),r}loadDocument(e){this.currentDocKey=e.docKey,this.currentDocTitle=e.title,this.currentName=e.title,this.markClean()}async openFile(){return this.hasFileSystemAccess()?this.openWithFSA():this.openWithInput()}async openWithFSA(){try{let[e]=await window.showOpenFilePicker({types:Et,multiple:!1}),t=await e.getFile(),n=await t.text(),r=this.toHtml(t.name,n);this.fileHandle=e,this.currentName=t.name,this.markClean();let i={name:t.name,html:r};return M.emit(N.FILE_OPENED,i),i}catch(e){if(e.name!==`AbortError`)throw e;return null}}openWithInput(){return new Promise(e=>{let t=document.createElement(`input`);t.type=`file`,t.accept=`.html,.htm,.txt`,t.onchange=async()=>{let n=t.files?.[0];if(!n){e(null);return}let r=await n.text(),i=this.toHtml(n.name,r);this.fileHandle=null,this.currentName=n.name,this.markClean();let a={name:n.name,html:i};M.emit(N.FILE_OPENED,a),e(a)},t.addEventListener(`cancel`,()=>e(null)),t.click()})}async saveFile(e){return this.fileHandle?this.writeToHandle(this.fileHandle,e,this.currentName):this.saveAsFile(e)}async saveAsFile(e,t=`document.html`){return this.hasFileSystemAccess()?this.saveWithFSA(e,t):this.saveWithDownload(e,t)}async saveWithFSA(e,t){try{let n=await window.showSaveFilePicker({suggestedName:t,types:Tt});return this.writeToHandle(n,e,n.name)}catch(e){if(e.name!==`AbortError`)throw e;return!1}}async writeToHandle(e,t,n){let r=await e.createWritable();return await r.write(t),await r.close(),this.fileHandle=e,this.currentName=n,this.markClean(),M.emit(N.FILE_SAVED,{name:n}),!0}saveWithDownload(e,t){let n=t.endsWith(`.txt`),r=n?$e(e):e,i=new Blob([r],{type:`${n?`text/plain`:`text/html`};charset=utf-8`}),a=URL.createObjectURL(i),o=document.createElement(`a`);return o.href=a,o.download=t,o.click(),URL.revokeObjectURL(a),this.markClean(),M.emit(N.FILE_SAVED,{name:t}),!0}printDocument(e,t){let n=t??{top:25,right:30,bottom:25,left:30},r=document.createElement(`iframe`);r.style.cssText=`position:fixed;top:0;left:0;width:0;height:0;visibility:hidden;border:none;`,document.body.appendChild(r);let i=r.contentWindow,a=r.contentDocument;if(!i||!a){r.remove();return}let o=Array.from(document.querySelectorAll(`link[rel="stylesheet"]`)).map(e=>e.outerHTML).join(`
`),s=`
<style>
...
${o}
${s}
</head><body>${e}</body></html>`),a.close();let c=()=>{r.remove()};i.onafterprint=c,setTimeout(()=>{r.parentNode&&c()},2e3),i.focus(),i.print()}htmlToPlainText(e){return $e(e)}toHtml(e,t){if(e.endsWith(`.txt`))return et(t);let n=Qe(t);return this.normalizeTableCells(n)}normalizeTableCells(e){let t=new DOMParser().parseFromString(e,`text/html`);return t.querySelectorAll(`td, th`).forEach(e=>{e.style.verticalAlign||(e.style.verticalAlign=`middle`)}),t.body.innerHTML}},Ot=(e,t)=>t.some(t=>e instanceof t),kt,At;function jt(){return kt||=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction]}function Mt(){return At||=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey]}var I=new WeakMap,Nt=new WeakMap,Pt=new WeakMap;function Ft(e){let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`success`,i),e.removeEventListener(`error`,a)},i=()=>{t(L(e.result)),r()},a=()=>{n(e.error),r()};e.addEventListener(`success`,i),e.addEventListener(`error`,a)});return Pt.set(t,e),t}function It(e){if(I.has(e))return;let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`complete`,i),e.removeEventListener(`error`,a),e.removeEventListener(`abort`,a)},i=()=>{t(),r()},a=()=>{n(e.error||new DOMException(`AbortError`,`AbortError`)),r()};e.addEventListener(`complete`,i),e.addEventListener(`error`,a),e.addEventListener(`abort`,a)});I.set(e,t)}var Lt={get(e,t,n){if(e instanceof IDBTransaction){if(t===`done`)return I.get(e);if(t===`store`)return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return L(e[t])},set(e,t,n){return e[t]=n,!0},has(e,t){return e instanceof IDBTransaction&&(t===`done`||t===`store`)?!0:t in e}};function Rt(e){Lt=e(Lt)}function zt(e){return Mt().includes(e)?function(...t){return e.apply(Vt(this),t),L(this.request)}:function(...t){return L(e.apply(Vt(this),t))}}function Bt(e){return typeof e==`function`?zt(e):(e instanceof IDBTransaction&&It(e),Ot(e,jt())?new Proxy(e,Lt):e)}function L(e){if(e instanceof IDBRequest)return Ft(e);if(Nt.has(e))return Nt.get(e);let t=Bt(e);return t!==e&&(Nt.set(e,t),Pt.set(t,e)),t}var Vt=e=>Pt.get(e);function Ht(e,t,{blocked:n,upgrade:r,blocking:i,terminated:a}={}){let o=indexedDB.open(e,t),s=L(o);return r&&o.addEventListener(`upgradeneeded`,e=>{r(L(o.result),e.oldVersion,e.newVersion,L(o.transaction),e)}),n&&o.addEventListener(`blocked`,e=>n(e.oldVersion,e.newVersion,e)),s.then(e=>{a&&e.addEventListener(`close`,()=>a()),i&&e.addEventListener(`versionchange`,e=>i(e.oldVersion,e.newVersion,e))}).catch(()=>{}),s}var Ut=[`get`,`getKey`,`getAll`,`getAllKeys`,`count`],Wt=[`put`,`add`,`delete`,`clear`],R=new Map;function Gt(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&typeof t==`string`))return;if(R.get(t))return R.get(t);let n=t.replace(/FromIndex$/,``),r=t!==n,i=Wt.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(i||Ut.includes(n)))return;let a=async function(e,...t){let a=this.transaction(e,i?`readwrite`:`readonly`),o=a.store;return r&&(o=o.index(t.shift())),(await Promise.all([o[n](...t),i&&a.done]))[0]};return R.set(t,a),a}Rt(e=>({...e,get:(t,n,r)=>Gt(t,n)||e.get(t,n,r),has:(t,n)=>!!Gt(t,n)||e.has(t,n)}));var Kt=[`continue`,`continuePrimaryKey`,`advance`],qt={},Jt=new WeakMap,Yt=new WeakMap,Xt={get(e,t){if(!Kt.includes(t))return e[t];let n=qt[t];return n||=qt[t]=function(...e){Jt.set(this,Yt.get(this)[t](...e))},n}};async function*Zt(...e){let t=this;if(t instanceof IDBCursor||(t=await t.openCursor(...e)),!t)return;t=t;let n=new Proxy(t,Xt);for(Yt.set(n,t),Pt.set(n,Vt(t));t;)yield n,t=await(Jt.get(n)||t.continue()),Jt.delete(n)}function Qt(e,t){return t===Symbol.asyncIterator&&Ot(e,[IDBIndex,IDBObjectStore,IDBCursor])||t===`iterate`&&Ot(e,[IDBIndex,IDBObjectStore])}Rt(e=>({...e,get(t,n,r){return Qt(t,n)?Zt:e.get(t,n,r)},has(t,n){return Qt(t,n)||e.has(t,n)}}));var $t=`poa-editor-autosave`,en=`snapshots`,tn=10,nn=300*1e3,rn=class{timer=null;intervalMs;constructor(e=nn){this.intervalMs=e}start(e){this.stop(),this.timer=setInterval(()=>{this.saveNow(e())},this.intervalMs)}stop(){this.timer!==null&&(clearInterval(this.timer),this.timer=null)}isRunning(){return this.timer!==null}async saveNow(e){let t=(await this.openDB()).transaction(en,`readwrite`);await t.store.put({html:e,savedAt:Date.now()});let n=await t.store.getAllKeys();n.length>tn&&await t.store.delete(n[0]),await t.done,M.emit(N.AUTOSAVE_SAVED,{savedAt:Date.now()})}async listSnapshots(){let e=await this.openDB(),[t,n]=await Promise.all([e.getAllKeys(en),e.getAll(en)]);return n.map((e,n)=>({id:t[n],html:e.html,savedAt:e.savedAt})).reverse()}async restoreSnapshot(e){return(await(await this.openDB()).get(en,e))?.html??null}async clearAll(){await(await this.openDB()).clear(en)}async openDB(){return Ht($t,1,{upgrade(e){e.objectStoreNames.contains(en)||e.createObjectStore(en,{autoIncrement:!0})}})}},an=`poa-settings`,on={fontFamily:`맑은 고딕`,fontSize:11,lineHeight:1.5,autoSaveEnabled:!0,autoSaveInterval:5,spellCheck:!1,changeWarning:!0};function sn(){try{let e=localStorage.getItem(an);return e?{...on,...JSON.parse(e)}:{...on}}catch{return{...on}}}function cn(e){try{localStorage.setItem(an,JSON.stringify(e))}catch{}}var ln=[`맑은 고딕`,`나눔고딕`,`나눔명조`,`굴림`,`돋움`,`바탕`,`궁서`,`Arial`,`Georgia`,`Times New Roman`,`Verdana`],un=[8,9,10,11,12,14,16,18,20,24,28,32],dn=[1,1.2,1.4,1.5,1.6,1.8,2,2.5],fn=[1,2,3,5,10,15,30],pn=`
:host { display: none; }
...
`;function mn(e,t,n){return`<option value="${e}"${n?` selected`:``}>${t}</option>`}var hn=class extends HTMLElement{shadow;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${pn}</style>
    ...
    <div class="body">
      <div class="section">
        ...
        <div class="row">
          ...
          <div class="row-ctrl">
            <select id="sel-font-family">${ln.map(e=>mn(e,e,!1)).join(``)}</select>
          </div>
        </div>
        <div class="row">
          <span class="row-label">글자 크기</span>
          <div class="row-ctrl">
            <select id="sel-font-size">${un.map(e=>mn(String(e),`${e}pt`,!1)).join(``)}</select>
          </div>
        </div>
        <div class="row">
          <span class="row-label">줄 간격</span>
          <div class="row-ctrl">
            <select id="sel-line-height">${dn.map(e=>mn(String(e),String(e),!1)).join(``)}</select>
          </div>
        </div>
      </div>
      <div class="section">
        ...
        <div class="row" id="row-interval">
          ...
          <div class="row-ctrl">
            <select id="sel-interval">${fn.map(e=>mn(String(e),`${e}분`,!1)).join(``)}</select>
          </div>
        </div>
      </div>
      <div class="section">
...
<div style="display:flex;justify-content:flex-end;gap:8px;margin-top:16px;">
  ...
  <button id="cp-ok" style="height:28px;padding:0 14px;border:1px solid #1565c0;border-radius:3px;background:#1565c0;color:#fff;cursor:pointer;">적용</button>
</div>`,a.appendChild(o),t.body.appendChild(a),o.querySelector(`#cp-bs`).value=i.borderStyle??`solid`;let d=o.querySelectorAll(`[data-va]`);d.forEach(e=>{e.addEventListener(`click`,()=>{d.forEach(e=>{e.style.cssText=`height:26px;padding:0 10px;border:1px solid #ccc;border-radius:3px;font-size:12px;cursor:pointer;background:#fff;color:#374151;transition:all .1s;`}),e.style.cssText=`height:26px;padding:0 10px;border:1px solid #1565c0;border-radius:3px;font-size:12px;cursor:pointer;background:#EFF6FF;color:#1565c0;font-weight:600;`})});let f=()=>a.remove();o.querySelector(`#cp-cancel`).addEventListener(`click`,f),a.addEventListener(`click`,e=>{e.target===a&&f()}),o.querySelector(`#cp-ok`).addEventListener(`click`,()=>{let e=o.querySelector(`[data-va][style*="#EFF6FF"]`),t={borderStyle:o.querySelector(`#cp-bs`).value,borderWidth:parseInt(o.querySelector(`#cp-bw`).value,10)||0,borderColor:o.querySelector(`#cp-bc`).value,indent:parseInt(o.querySelector(`#cp-ind`).value,10)||0,bgColor:o.querySelector(`#cp-bg`).value,fontSize:parseInt(o.querySelector(`#cp-fs`).value,10)||0,verticalAlign:e?.dataset.va??u,id:o.querySelector(`#cp-id`).value.trim(),className:o.querySelector(`#cp-cls`).value.trim()};for(let e of r)vn.applyCellProperties(e,t);this.cb.onModified?.(),f()})}findCell(e){let t=e;for(;t;){if(t.nodeType===Node.ELEMENT_NODE){let e=t.tagName.toLowerCase();if(e===`td`||e===`th`)return t;if(e===`table`)break}t=t.parentNode}return null}},An=`padding:6px 8px;overflow:hidden;word-break:break-word;`;function jn(e){return Array.from(e.querySelectorAll(`td,th`))}function Mn(e){return Array.from(e.querySelectorAll(`thead td,thead th`))}function Nn(e){return Array.from(e.querySelectorAll(`tbody tr`))}function Pn(e){return`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40">${e}</svg>`}var Fn={"border-all":Pn(`
    ...
    <line x1="3"  y1="25" x2="37" y2="25" stroke="#999" stroke-width="1" stroke-dasharray="3,2"/>`)},In=[{id:`border-all`,label:`전체 테두리`,icon:Fn[`border-all`],baseOptions:{width:`100%`,border:1,borderColor:`#cccccc`,headerPosition:`none`},apply:e=>{for(let t of jn(e))t.style.cssText=`border:1px solid #ccc;${An}`}},{id:`border-thick`,label:`굵은 외부`,icon:Fn[`border-thick`],baseOptions:{width:`100%`,border:1,borderColor:`#aaaaaa`,headerPosition:`none`},apply:e=>{for(let t of jn(e))t.style.cssText=`border:1px solid #aaa;${An}`;e.style.boxShadow=`0 0 0 2px #333333`}},{id:`header-light`,label:`헤더 강조`,icon:Fn[`header-light`],baseOptions:{width:`100%`,border:1,borderColor:`#cccccc`,headerPosition:`top`},apply:e=>{for(let t of jn(e))t.style.cssText=`border:1px solid #ccc;${An}`;for(let t of Mn(e))t.style.cssText=`border:1px solid #ccc;${An}background:#f0f0f0;font-weight:bold;`}},{id:`header-dark`,label:`헤더 진한`,icon:Fn[`header-dark`],baseOptions:{width:`100%`,border:1,borderColor:`#aaaaaa`,headerPosition:`top`},apply:e=>{for(let t of jn(e))t.style.cssText=`border:1px solid #aaa;${An}`;for(let t of Mn(e))t.style.cssText=`border:1px solid #555;${An}background:#333333;color:#ffffff;font-weight:bold;`}},{id:`stripe-light`,label:`줄무늬`,icon:Fn[`stripe-light`],baseOptions:{width:`100%`,border:1,borderColor:`#dddddd`,headerPosition:`none`},apply:e=>{for(let t of jn(e))t.style.cssText=`border:1px solid #ddd;${An}`;Nn(e).forEach((e,t)=>{let n=t%2==0?`#f9f9f9`:``;for(let t of Array.from(e.querySelectorAll(`td,th`)))t.style.backgroundColor=n})}},{id:`stripe-dark`,label:`진한 줄무늬`,icon:Fn[`stripe-dark`],baseOptions:{width:`100%`,border:1,borderColor:`#bbbbbb`,headerPosition:`none`},apply:e=>{for(let t of jn(e))t.style.cssText=`border:1px solid #bbb;${An}`;Nn(e).forEach((e,t)=>{let n=t%2==0?`#e0e0e0`:``;for(let t of Array.from(e.querySelectorAll(`td,th`)))t.style.backgroundColor=n})}},{id:`borderless`,label:`테두리 없음`,icon:Fn.borderless,baseOptions:{width:`100%`,border:0,headerPosition:`none`},apply:e=>{for(let t of jn(e))t.style.cssText=`border:none;${An}`;e.removeAttribute(`border`)}},{id:`dashed`,label:`점선 테두리`,icon:Fn.dashed,baseOptions:{width:`100%`,border:1,borderColor:`#999999`,headerPosition:`none`},apply:e=>{for(let t of jn(e))t.style.cssText=`border:1px dashed #999;${An}`}}];function Ln(e,t){In.find(t=>t.id===e)?.apply(t)}var Rn=new Set([`http:`,`https:`,`mailto:`,`tel:`]);function zn(e){if(e.startsWith(`#`))return e.length>1;try{let t=new URL(e);return Rn.has(t.protocol)}catch{return!1}}var Bn=class{root;savedRange=null;constructor(e){this.root=e}saveSelection(){let e=this.root.ownerDocument.getSelection();e&&e.rangeCount>0&&(this.savedRange=e.getRangeAt(0).cloneRange())}insertLink(e){if(!zn(e.href))throw Error(`유효하지 않은 URL입니다.`);let t=this.root.ownerDocument.createElement(`a`);t.href=e.href,e.title&&(t.title=e.title),e.target===`_blank`&&(t.target=`_blank`,t.rel=`noopener noreferrer`),t.textContent=this.savedRange?.toString().trim()||e.text.trim()||e.href,e.target===`_self`&&(t.target=`_self`),this.insertNode(t)}updateLink(e,t){if(t.href!==void 0){if(!zn(t.href))throw Error(`유효하지 않은 URL입니다.`);e.href=t.href}t.text!==void 0&&(e.textContent=t.text),t.title!==void 0&&(e.title=t.title),t.target!==void 0&&(t.target===`_blank`?(e.target=`_blank`,e.rel=`noopener noreferrer`):(e.target=`_self`,e.removeAttribute(`rel`)))}removeLink(e){let t=e.parentNode;if(t){for(;e.firstChild;)t.insertBefore(e.firstChild,e);t.removeChild(e)}}getFocusedAnchor(){let e=this.root.ownerDocument.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).startContainer;for(;t&&t!==this.root;){if(t.nodeType===Node.ELEMENT_NODE&&t.tagName===`A`)return t;t=t.parentNode}return null}insertNode(e){let t=this.root.ownerDocument,n=t.getSelection(),r;this.savedRange?(r=this.savedRange.cloneRange(),this.savedRange=null):n&&n.rangeCount>0?r=n.getRangeAt(0):(r=t.createRange(),r.selectNodeContents(this.root),r.collapse(!1)),r.deleteContents(),r.insertNode(e),r.setStartAfter(e),r.collapse(!0),n?.removeAllRanges(),n?.addRange(r)}};function Vn(){let e=new Uint8Array(6);return crypto.getRandomValues(e),Array.from(e,e=>e.toString(16).padStart(2,`0`)).join(``)}var Hn=class{root;savedRange=null;constructor(e){this.root=e}saveSelection(){let e=this.root.ownerDocument.getSelection();e&&e.rangeCount>0&&(this.savedRange=e.getRangeAt(0).cloneRange())}insert(e){let t=`bm-${Vn()}`,n=this.root.ownerDocument.createElement(`a`);return n.id=t,n.setAttribute(`name`,t),n.className=`poa-bookmark`,n.setAttribute(`data-label`,e),n.title=e||t,n.textContent=`[${e||t}]`,n.contentEditable=`false`,this.insertAtRange(n),t}getAll(){return Array.from(this.root.querySelectorAll(`a.poa-bookmark[id^="bm-"]`)).map(e=>({id:e.id,label:e.getAttribute(`data-label`)??e.id,element:e}))}update(e,t){let n=this.root.querySelector(`a[id="${e}"]`);if(!n)throw Error(`책갈피 '${e}'를 찾을 수 없습니다.`);n.setAttribute(`data-label`,t),n.title=t,n.textContent=`[${t||e}]`}remove(e){this.root.querySelector(`a[id="${e}"]`)?.remove()}insertAtRange(e){let t=this.root.ownerDocument,n=t.getSelection(),r;this.savedRange?(r=this.savedRange.cloneRange(),this.savedRange=null):n&&n.rangeCount>0?r=n.getRangeAt(0):(r=t.createRange(),r.selectNodeContents(this.root),r.collapse(!1)),r.collapse(!0),r.insertNode(e),r.setStartAfter(e),r.collapse(!0),n?.removeAllRanges(),n?.addRange(r)}},Un=[{dir:`nw`,cursor:`nw-resize`,top:`0`,left:`0`},{dir:`n`,cursor:`n-resize`,top:`0`,left:`50%`},{dir:`ne`,cursor:`ne-resize`,top:`0`,left:`100%`},{dir:`e`,cursor:`e-resize`,top:`50%`,left:`100%`},{dir:`se`,cursor:`se-resize`,top:`100%`,left:`100%`},{dir:`s`,cursor:`s-resize`,top:`100%`,left:`50%`},{dir:`sw`,cursor:`sw-resize`,top:`100%`,left:`0`},{dir:`w`,cursor:`w-resize`,top:`50%`,left:`0`}],Wn=20,Gn=class{root;cb;overlay=null;activeImg=null;dragging=!1;dragDir=`se`;dragStartX=0;dragStartY=0;dragStartW=0;dragStartH=0;constructor(e,t={}){this.root=e,this.cb=t}attach(){this.root.style.position||(this.root.style.position=`relative`),this.root.addEventListener(`click`,this.onRootClick,!0),this.root.addEventListener(`contextmenu`,this.onContextMenu),this.root.addEventListener(`input`,this.onContentInput),document.addEventListener(`mousemove`,this.onMouseMove),document.addEventListener(`mouseup`,this.onMouseUp)}detach(){this.deactivate(),this.root.removeEventListener(`click`,this.onRootClick,!0),this.root.removeEventListener(`contextmenu`,this.onContextMenu),this.root.removeEventListener(`input`,this.onContentInput),document.removeEventListener(`mousemove`,this.onMouseMove),document.removeEventListener(`mouseup`,this.onMouseUp)}getActiveImage(){return this.activeImg}syncOverlay(){this.updatePos()}deactivate(){this.overlay?.remove(),this.overlay=null,this.activeImg&&(this.activeImg=null,this.cb.onDeactivate?.())}activate(e){this.activeImg!==e&&(this.overlay?.remove(),this.activeImg=e,this.createOverlay(),this.cb.onActivate?.(e))}createOverlay(){if(!this.activeImg)return;let e=document.createElement(`div`);e.className=`poa-img-resize-overlay`,e.dataset.poaTemp=`true`,e.style.cssText=`position:absolute;border:2px solid #0078d7;pointer-events:none;z-index:10;box-sizing:border-box;`;for(let t of Un){let n=document.createElement(`div`);n.dataset.dir=t.dir,n.style.cssText=`position:absolute;width:8px;height:8px;background:#0078d7;border:1px solid #fff;border-radius:1px;box-sizing:border-box;cursor:${t.cursor};top:${t.top};left:${t.left};transform:translate(-50%,-50%);pointer-events:all;z-index:11;`,n.addEventListener(`mousedown`,this.onHandleMouseDown),e.appendChild(n)}this.root.appendChild(e),this.overlay=e,this.updatePos()}updatePos(){if(!this.overlay||!this.activeImg)return;let e=this.activeImg.getBoundingClientRect(),t=this.root.getBoundingClientRect(),n=e.top-t.top+this.root.scrollTop,r=e.left-t.left+this.root.scrollLeft;Object.assign(this.overlay.style,{top:`${n}px`,left:`${r}px`,width:`${e.width}px`,height:`${e.height}px`})}onRootClick=e=>{let t=e.target;this.overlay?.contains(t)||(t.tagName===`IMG`?this.activate(t):this.deactivate())};onContextMenu=e=>{let t=e.target;if(t.tagName!==`IMG`)return;e.preventDefault();let n=t;this.activate(n),this.cb.onContextMenu?.(n,e.clientX,e.clientY)};onContentInput=()=>{this.activeImg&&!this.root.contains(this.activeImg)&&this.deactivate()};onHandleMouseDown=e=>{if(!this.activeImg)return;let t=e.currentTarget.dataset.dir;e.preventDefault(),e.stopPropagation();let n=this.activeImg.getBoundingClientRect();this.dragging=!0,this.dragDir=t,this.dragStartX=e.clientX,this.dragStartY=e.clientY,this.dragStartW=n.width,this.dragStartH=n.height,document.body.style.cursor=e.currentTarget.style.cursor,document.body.style.userSelect=`none`};onMouseMove=e=>{if(!this.dragging||!this.activeImg)return;let t=e.clientX-this.dragStartX,n=e.clientY-this.dragStartY,r=this.dragDir,i=this.root.clientWidth,a=this.dragStartW,o=this.dragStartH;(r===`e`||r===`ne`||r===`se`)&&(a=this.dragStartW+t),(r===`w`||r===`nw`||r===`sw`)&&(a=this.dragStartW-t),(r===`s`||r===`se`||r===`sw`)&&(o=this.dragStartH+n),(r===`n`||r===`ne`||r===`nw`)&&(o=this.dragStartH-n);let s=r===`nw`||r===`ne`||r===`sw`||r===`se`;if(e.shiftKey&&s&&this.dragStartH>0){let e=this.dragStartW/this.dragStartH;Math.abs(t)>=Math.abs(n)?o=a/e:a=o*e}a=Math.max(Wn,Math.min(i,a)),o=Math.max(Wn,o),this.activeImg.style.width=`${Math.round(a)}px`,this.activeImg.style.height=`${Math.round(o)}px`,this.updatePos(),this.cb.onResize?.(this.activeImg)};onMouseUp=()=>{this.dragging&&(this.dragging=!1,document.body.style.cursor=``,document.body.style.userSelect=``,this.activeImg&&(this.updatePos(),this.cb.onResizeEnd?.()))}},Kn=794,qn=1123,Jn=24,Yn={top:60,right:80,bottom:60,left:80},Xn=`poa-print-styles`,Zn=class{container=null;mount(e,t,n=[],r=Yn){this.container=e,e.innerHTML=``;let i=document.createElement(`div`);i.className=`poa-page-main`,i.style.cssText=`flex:1;overflow-y:auto;padding:20px;display:flex;flex-direction:column;align-items:center;background:#e8e8e8;`,this.injectPrintStyles(r);let a=this.splitByPageBreaks(t);for(let e of a)i.appendChild(this.buildPage(e,r));e.appendChild(i),n.length>0&&e.appendChild(this.buildSidebar(n))}unmount(){this.container&&=(this.container.innerHTML=``,null),document.getElementById(Xn)?.remove()}getPageCount(e){return this.splitByPageBreaks(e).length}buildPage(e,t){let n=document.createElement(`div`);return n.className=`poa-a4-page`,n.style.cssText=[`width:${Kn}px`,`min-height:${qn}px`,`background:#fff`,`box-shadow:0 2px 8px rgba(0,0,0,.2)`,`padding:${t.top}px ${t.right}px ${t.bottom}px ${t.left}px`,`box-sizing:border-box`,`margin-bottom:20px`,`position:relative`,`font-size:14px`,`line-height:1.6`].join(`;`),n.innerHTML=e,n}buildSidebar(e){let t=document.createElement(`div`);t.className=`poa-page-sidebar`,t.style.cssText=[`width:180px`,`flex-shrink:0`,`overflow-y:auto`,`background:#fafafa`,`border-left:1px solid #ddd`,`padding:12px`].join(`;`);let n=document.createElement(`div`);n.style.cssText=`font-size:12px;font-weight:600;color:#555;margin-bottom:8px;padding-bottom:6px;border-bottom:1px solid #eee;`,n.textContent=`책갈피`,t.appendChild(n);for(let n of e){let e=document.createElement(`a`);e.href=`#${n.id}`,e.textContent=n.label,e.style.cssText=`display:block;font-size:12px;color:#1976d2;text-decoration:none;padding:5px 0;border-bottom:1px solid #f0f0f0;`,e.addEventListener(`mouseenter`,()=>{e.style.textDecoration=`underline`}),e.addEventListener(`mouseleave`,()=>{e.style.textDecoration=`none`}),t.appendChild(e)}return t}splitByPageBreaks(e){let t=e.split(/<hr[^>]*class="[^"]*poa-page-break[^"]*"[^>]*\/?>|<div[^>]*class="[^"]*poa-page-break[^"]*"[^>]*>[\s\S]*?<\/div>/gi);return t.length>0?t:[e]}injectPrintStyles(e){if(document.getElementById(Xn))return;let t=document.createElement(`style`);t.id=Xn,t.textContent=`
@media print {
    ...
    <div class="pf-row2">
      <div class="pf-field" style="margin-bottom:0;">
        ...
        <div style="display:flex;align-items:center;gap:4px;">
          <input id="pf-width" type="number" value="${x}" min="60" max="800" step="1"
...
</div>`,ue=n.defaultView,C=ue?ue.innerWidth:1920,de=ue?ue.innerHeight:1080,w=r.left,fe=r.bottom+6;fe+340>de&&(fe=r.top-340-6),w+320>C&&(w=r.right-320),w=Math.max(4,w),fe=Math.max(4,fe);let T=n.createElement(`div`);T.className=`poa-field-popup`,T.style.cssText=[`position:fixed`,`left:${Math.round(w)}px`,`top:${Math.round(fe)}px`,`width:320px`,`background:#fff`,`border:1px solid #E2E8F0`,`border-radius:12px`,`box-shadow:0 10px 40px rgba(0,0,0,.15),0 2px 8px rgba(0,0,0,.08)`,`z-index:99999`,`font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif`,`font-size:13px`,`overflow:hidden`].join(`;`),T.innerHTML=`
<div id="pf-header" style="padding:10px 12px 10px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #F1F5F9;gap:8px;cursor:move;">
  <div style="display:flex;align-items:center;gap:8px;min-width:0;">
    <span style="display:inline-flex;align-items:center;justify-content:center;width:26px;height:26px;background:linear-gradient(135deg,#3B82F6,#2563EB);border-radius:7px;color:#fff;font-size:11px;font-weight:700;flex-shrink:0;">${vi[u]??`T`}</span>
...
</div>`,n.body.appendChild(T),this.popupEl=T;let pe=e=>T.querySelector(`#${e}`),me=()=>(v.tagName,v.value),he=e=>{v.tagName,v.value=e};T.querySelector(`#pf-value`).addEventListener(`input`,e=>{let n=e.target.value;if(h){t.setAttribute(H.rawValue,n);let e=t.getAttribute(H.numberFormat)??`none`;he(e===`none`?n:Oi(n,e))}else if(ee){t.setAttribute(H.rawValue,n);let e=t.getAttribute(H.dateFormat)??`YYYY-MM-DD`;he(n?Di(n,e):``)}else he(n)}),pe(`pf-prefix`).addEventListener(`input`,e=>{t.setAttribute(H.prefix,e.target.value)}),pe(`pf-suffix`).addEventListener(`input`,e=>{t.setAttribute(H.suffix,e.target.value)}),pe(`pf-fontsize`).addEventListener(`change`,e=>{let n=e.target.value;t.setAttribute(H.fontSize,n),n===`0`?v.style.fontSize=``:v.style.fontSize=`${n}px`}),pe(`pf-font`).addEventListener(`change`,e=>{let n=e.target.value;t.setAttribute(H.fontFamily,n),v.style.fontFamily=n||`inherit`}),pe(`pf-size-fixed`).addEventListener(`change`,e=>{let n=e.target.value;t.setAttribute(H.sizeFixed,n),v.style.resize=n===`1`?`none`:v.tagName===`TEXTAREA`?`both`:`horizontal`}),pe(`pf-multiline`).addEventListener(`change`,e=>{let r=e.target.value===`1`;if(r===(v.tagName===`TEXTAREA`))return;let i=me(),a=v.getAttribute(`placeholder`)??``,o=t.getAttribute(H.fieldId)??``;t.setAttribute(H.multiline,r?`1`:`0`);let s=r?this.createTextarea(n,a,o):this.createInput(n,a,o);r&&(s.rows=3);let c=t.getAttribute(H.fontSize)??`0`;s.style.fontSize=c===`0`?`inherit`:`${c}px`;let l=t.getAttribute(H.fontFamily)??``;s.style.fontFamily=l||`inherit`,s.style.textAlign=t.getAttribute(H.textAlign)??`left`;let u=t.getAttribute(H.sizeFixed)??`0`;s.style.resize=u===`1`?`none`:r?`both`:`horizontal`;let d=t.getAttribute(H.dataWidth),f=t.getAttribute(H.dataHeight);d&&(s.style.width=`${d}px`),f&&r&&(s.style.height=`${f}px`),r?s.value=i:s.value=i.replace(/\n/g,` `),v.replaceWith(s),v=s,this.attachResizeObserver(s,t)}),h&&pe(`pf-numformat`).addEventListener(`change`,e=>{let n=e.target.value;t.setAttribute(H.numberFormat,n);let r=t.getAttribute(H.rawValue)??``;he(n===`none`?r:Oi(r,n))}),ee&&pe(`pf-dateformat`).addEventListener(`change`,e=>{let n=e.target.value;t.setAttribute(H.dateFormat,n);let r=t.getAttribute(H.rawValue)??``;r&&he(Di(r,n));let i=T.querySelector(`#pf-value`);i&&(i.placeholder=Ei[n]??`예) 20261231`)}),T.querySelector(`#pf-width`)?.addEventListener(`change`,e=>{let n=parseInt(e.target.value,10)||60;n=Math.max(60,Math.min(800,n)),e.target.value=String(n),v.style.width=`${n}px`,t.setAttribute(H.dataWidth,String(n))}),ce&&T.querySelector(`#pf-height`)?.addEventListener(`change`,e=>{let n=parseInt(e.target.value,10)||28;n=Math.max(28,Math.min(600,n)),e.target.value=String(n),v.style.height=`${n}px`,t.setAttribute(H.dataHeight,String(n))}),T.querySelectorAll(`.pf-align-btn`).forEach(e=>{e.addEventListener(`click`,()=>{T.querySelectorAll(`.pf-align-btn`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let n=e.dataset.align??`left`;t.setAttribute(H.textAlign,n),v.style.textAlign=n})}),T.querySelectorAll(`.pf-sec-hdr`).forEach(e=>{e.addEventListener(`click`,()=>{let t=T.querySelector(`#pf-body-${e.dataset.sec}`),n=e.querySelector(`.pf-sec-arrow`);if(!t||!n)return;let r=t.style.display!==`none`;t.style.display=r?`none`:`block`,n.textContent=r?`▸`:`▾`})}),T.querySelectorAll(`.pf-move-btn`).forEach(e=>{e.addEventListener(`mousedown`,r=>{r.preventDefault(),r.stopPropagation();let i=e.dataset.dir;if(!i||!t.parentNode)return;let a=t.parentElement,o=a?.tagName===`TD`||a?.tagName===`TH`;switch(i){case`left`:{let e=t.previousSibling;e&&(!o||a?.contains(e))&&(t.parentNode.insertBefore(t,e),this.contentEl?.dispatchEvent(new Event(`input`,{bubbles:!0})));break}case`right`:{let e=t.nextSibling;e&&(!o||a?.contains(e))&&(t.parentNode.insertBefore(e,t),this.contentEl?.dispatchEvent(new Event(`input`,{bubbles:!0})));break}case`up`:{let e=n.createRange();e.setStartBefore(t),e.collapse(!0);let r=n.getSelection();r?.removeAllRanges(),r?.addRange(e),this.contentEl?.focus();break}case`down`:{let e=n.createRange();e.setStartAfter(t),e.collapse(!0);let r=n.getSelection();r?.removeAllRanges(),r?.addRange(e),this.contentEl?.focus();break}}})});let ge=pe(`pf-close`);ge.addEventListener(`mouseenter`,()=>{ge.style.background=`#F1F5F9`,ge.style.color=`#374151`}),ge.addEventListener(`mouseleave`,()=>{ge.style.background=`#F8FAFC`,ge.style.color=`#94A3B8`}),ge.addEventListener(`click`,()=>this.closePopup());let _e=e=>{this.popupEl?.contains(e.target)||(this.closePopup(),n.removeEventListener(`mousedown`,_e))};setTimeout(()=>n.addEventListener(`mousedown`,_e),0),T.querySelector(`#pf-header`).addEventListener(`mousedown`,e=>{if(e.target.closest(`button`))return;e.preventDefault();let t=e.clientX,r=e.clientY,i=parseInt(T.style.left,10),a=parseInt(T.style.top,10),o=e=>{let n=e.clientX-t,o=e.clientY-r,s=Math.max(4,Math.min(i+n,(ue?.innerWidth??1920)-320-4)),c=Math.max(4,Math.min(a+o,(ue?.innerHeight??1080)-60));T.style.left=`${Math.round(s)}px`,T.style.top=`${Math.round(c)}px`},s=()=>{n.removeEventListener(`mousemove`,o),n.removeEventListener(`mouseup`,s),this.dragCleanup=null};n.addEventListener(`mousemove`,o),n.addEventListener(`mouseup`,s),this.dragCleanup=()=>{n.removeEventListener(`mousemove`,o),n.removeEventListener(`mouseup`,s)}})}closePopup(){this.dragCleanup?.(),this.dragCleanup=null,this.popupEl&&=(this.popupEl.remove(),null)}static exportFields(e){let t=new DOMParser().parseFromString(e,`text/html`);return t.querySelectorAll(`.poa-field`).forEach(e=>{let n=e.getAttribute(`data-label`)??``,r=(e.getAttribute(`data-placeholder`)??``)||n,i=e.getAttribute(`data-prefix`)??``,a=e.getAttribute(`data-suffix`)??``,o=e.getAttribute(`data-width`),s=e.getAttribute(`data-height`),c=e.querySelector(`.poa-field-input`),l=``;l=c?.tagName===`TEXTAREA`?c.textContent?.trim()??``:c?.getAttribute(`value`)?.trim()??``;let u=e.getAttribute(`data-field-type`)??``,d=e.getAttribute(`data-raw-value`)??``,f;f=l===``?r:u===`date`&&d?Di(d,e.getAttribute(`data-date-format`)??`YYYY-MM-DD`):l;let p=`${i}${f}${a}`;if(o||s){let n=t.createElement(`span`);n.style.display=`inline-block`,o&&(n.style.width=`${o}px`),s&&(n.style.minHeight=`${s}px`),n.textContent=p,e.replaceWith(n)}else e.replaceWith(t.createTextNode(p))}),t.body.innerHTML}},Ni=[{id:`A3`,label:`A3`,widthPx:1123,heightPx:1587,widthMm:297,heightMm:420},{id:`A4`,label:`A4`,widthPx:794,heightPx:1123,widthMm:210,heightMm:297},{id:`A5`,label:`A5`,widthPx:559,heightPx:794,widthMm:148,heightMm:210},{id:`B4`,label:`B4`,widthPx:945,heightPx:1335,widthMm:250,heightMm:353},{id:`B5`,label:`B5`,widthPx:665,heightPx:945,widthMm:176,heightMm:250},{id:`Letter`,label:`Letter`,widthPx:816,heightPx:1056,widthMm:215.9,heightMm:279.4},{id:`Legal`,label:`Legal`,widthPx:816,heightPx:1344,widthMm:215.9,heightMm:355.6}],Pi={top:25,right:30,bottom:25,left:30},Fi=3.7795,Ii=class e{editableArea;wrapperEl;currentSize;currentZoom;currentMargin;static ZOOM_MIN=50;static ZOOM_MAX=200;static ZOOM_STEP=10;static STORAGE_KEY_SIZE=`poa-paper-size`;static STORAGE_KEY_ZOOM=`poa-editor-zoom`;static STORAGE_KEY_MARGIN=`poa-paper-margin`;constructor(e,t){this.editableArea=e,this.wrapperEl=t,this.currentSize=Ni.find(e=>e.id===`A4`),this.currentZoom=100,this.currentMargin={...Pi}}init(){try{let t=localStorage.getItem(e.STORAGE_KEY_SIZE);if(t){let e=Ni.find(e=>e.id===t);e&&(this.currentSize=e)}let n=localStorage.getItem(e.STORAGE_KEY_ZOOM);if(n){let t=parseInt(n,10);isNaN(t)||(this.currentZoom=Math.min(e.ZOOM_MAX,Math.max(e.ZOOM_MIN,t)))}let r=localStorage.getItem(e.STORAGE_KEY_MARGIN);if(r){let e=JSON.parse(r);this.currentMargin={...Pi,...e}}}catch{}this.applyToEditor()}setPaperSize(e){let t=Ni.find(t=>t.id===e);t&&(this.currentSize=t,this.applyToEditor())}setZoom(t){let n=Math.round(t/e.ZOOM_STEP)*e.ZOOM_STEP;this.currentZoom=Math.min(e.ZOOM_MAX,Math.max(e.ZOOM_MIN,n)),this.applyToEditor()}setMargin(e){this.currentMargin={...this.currentMargin,...e},this.applyToEditor()}zoomIn(){this.setZoom(this.currentZoom+e.ZOOM_STEP)}zoomOut(){this.setZoom(this.currentZoom-e.ZOOM_STEP)}resetZoom(){this.setZoom(100)}getSize(){return this.currentSize}getZoom(){return this.currentZoom}getMargin(){return{...this.currentMargin}}applyToEditor(){let{widthPx:t,heightPx:n}=this.currentSize,r=this.currentZoom/100,{top:i,right:a,bottom:o,left:s}=this.currentMargin,c=Math.round(i*Fi),l=Math.round(a*Fi),u=Math.round(o*Fi),d=Math.round(s*Fi);this.editableArea.style.width=`${t}px`,this.editableArea.style.minHeight=`${n}px`,this.editableArea.style.height=`auto`,this.editableArea.style.padding=`${c}px ${l}px ${u}px ${d}px`,this.editableArea.style.boxSizing=`border-box`,this.editableArea.style.overflowY=`visible`,this.editableArea.style.overflowX=`visible`,this.editableArea.style.flex=`0 0 auto`,this.editableArea.style.transform=`scale(${r})`,this.editableArea.style.transformOrigin=`top center`,this.editableArea.style.margin=`0 auto`,this.editableArea.style.backgroundColor=`var(--poa-editor-bg, #fff)`,this.wrapperEl.style.background=`#e5e5e5`,this.wrapperEl.style.padding=`20px`,this.wrapperEl.style.overflowY=`auto`,this.wrapperEl.style.overflowX=`auto`,this.wrapperEl.style.display=`flex`,this.wrapperEl.style.flexDirection=`column`,this.wrapperEl.style.alignItems=`center`,this.wrapperEl.style.justifyContent=`flex-start`;try{localStorage.setItem(e.STORAGE_KEY_SIZE,this.currentSize.id),localStorage.setItem(e.STORAGE_KEY_ZOOM,String(this.currentZoom)),localStorage.setItem(e.STORAGE_KEY_MARGIN,JSON.stringify(this.currentMargin))}catch{}this.wrapperEl.dispatchEvent(new CustomEvent(`paper-change`,{bubbles:!0,detail:{size:this.currentSize,zoom:this.currentZoom,margin:this.currentMargin}}))}};function Li(){let e=new URLSearchParams(window.location.search);return e.get(`role`)===`admin`?`admin`:e.get(`mode`)===`user`?`user`:`write`}function Ri(){return Li()===`admin`}function zi(){return Li()===`write`}function Bi(){return Li()===`user`}function Vi(){return new URLSearchParams(window.location.search).get(`template`)}function Hi(){let{origin:e,pathname:t}=window.location,n=e+t.replace(/\/index\.html$/,`/`).replace(/\/[^/]*\.[^/]*$/,`/`);return n.endsWith(`/`)?n:n+`/`}function Ui(e){return Hi()+`?mode=user&template=`+encodeURIComponent(e)}function Wi(){let e=new URLSearchParams(window.location.search);return{width:e.get(`width`)??`100%`,height:e.get(`height`)??`100%`}}var Gi=`http://192.168.50.120:8080/api/v1`;function Ki(e){return`s-${e}`}function U(e){if(!e.startsWith(`s-`))return null;let t=Number(e.slice(2));return Number.isFinite(t)?t:null}function qi(e){return{id:Ki(e.id),type:`folder`,name:e.name,parentId:e.parentId===null?null:Ki(e.parentId),isPublic:e.isPublic,createdBy:e.createdBy??null,createdAt:new Date(e.createdAt).getTime(),updatedAt:new Date(e.updatedAt).getTime(),order:e.orderIndex}}function Ji(e){return{id:Ki(e.id),type:`template`,name:e.name,parentId:e.folderId===null?null:Ki(e.folderId),content:e.content??``,isPublic:e.isPublic,...e.isTemp?{isTemp:!0}:{},createdBy:e.createdBy??null,createdAt:new Date(e.createdAt).getTime(),updatedAt:new Date(e.updatedAt).getTime(),order:e.orderIndex}}async function W(e,t){let n=await fetch(`${Gi}${e}`,{...t,headers:{"Content-Type":`application/json`,"Poa-User-Id":Ue(),...t?.headers??{}}});if(n.status===204)return;let r=await n.json();if(!r.success)throw Error(r.message??`API 오류`);return r.data}var G={async getFolders(){return(await W(`/folders`)).map(qi)},async createFolder(e){return qi(await W(`/folders`,{method:`POST`,body:JSON.stringify(e)}))},async updateFolder(e,t){return qi(await W(`/folders/${e}`,{method:`PUT`,body:JSON.stringify(t)}))},async deleteFolder(e){await W(`/folders/${e}`,{method:`DELETE`})},async getTemplates(e){return(await W(`/templates${e===void 0?``:`?folderId=${e}`}`)).map(Ji)},async getTemplate(e){return Ji(await W(`/templates/${e}`))},async createTemplate(e){return Ji(await W(`/templates`,{method:`POST`,body:JSON.stringify(e)}))},async updateTemplate(e,t){return Ji(await W(`/templates/${e}`,{method:`PUT`,body:JSON.stringify(t)}))},async deleteTemplate(e){await W(`/templates/${e}`,{method:`DELETE`})},async deleteTempTemplates(){await W(`/templates/temp`,{method:`DELETE`})},async adminCleanup(){let e=()=>W(`/admin/cleanup`,{method:`DELETE`});try{await e()}catch(t){console.error(`서버 정리 오류 (1차 시도):`,t),await new Promise(e=>setTimeout(e,500)),await e()}},async getAllNodes(){let[e,t]=await Promise.all([this.getFolders(),this.getTemplates()]);return[...e,...t]}},Yi=`1.0.0`,Xi=class{opts;msgHandler=e=>this.handleMessage(e);constructor(e){this.opts=e}attach(){window.addEventListener(`message`,this.msgHandler),setTimeout(()=>{window.parent.postMessage({type:`POA_READY`,version:Yi},`*`)},0)}detach(){window.removeEventListener(`message`,this.msgHandler)}notifyContentChanged(e,t,n){window.parent!==window&&window.parent.postMessage({type:`POA_CONTENT_CHANGED`,html:e,charCount:t,wordCount:n},`*`)}notifySaved(e,t){window.parent!==window&&window.parent.postMessage({type:`POA_SAVED`,docKey:e,title:t},`*`)}applySize(e,t){let{editorEl:n}=this.opts;e&&(n.style.width=e),t&&(n.style.height=t,n.style.flex=`none`)}handleMessage(e){if(!e.data||typeof e.data.type!=`string`)return;let t=e.data;switch(t.type){case`POA_RESIZE`:this.applySize(typeof t.width==`string`?t.width:void 0,typeof t.height==`string`?t.height:void 0);break;case`POA_FULLSCREEN`:t.enabled?document.documentElement.requestFullscreen?.():document.exitFullscreen?.();break;case`POA_GET_CONTENT`:e.source?.postMessage({type:`POA_CONTENT`,html:this.opts.getHTML()},`*`);break;case`POA_SET_CONTENT`:typeof t.html==`string`&&this.opts.setHTML(D.sanitize(t.html));break}}},Zi=2,Qi=new Set([`p`,`div`,`h1`,`h2`,`h3`,`h4`,`h5`,`h6`,`li`,`blockquote`,`pre`]);function $i(e){return!e||e===`inherit`?e:e.split(`,`).map(e=>{let t=e.trim().replace(/^['"](.*)['"]\s*$/,`$1`);return/\s/.test(t)?`"${t}"`:t}).join(`, `)}var ea=class t extends HTMLElement{shadow;core;contentEl;toolbar;statusBar;savedRange=null;clipboardHandler;findReplace;imageInserter;fileManager;autoSave;findDialog;imageDialog;imageInsertDialog;settingsDialog;fileManagerDialog;documentListDialog;docTitleDialog;tableDialog;cellSplitDialog;cellMerger;tableNavigator;tableResizer;tableSelector;tableHandle;tableContextMenu;linkInserter;bookmarkManager;linkDialog;imageResizer;imageToolbar;imgContextMenu=null;linkContextMenu=null;viewManager;tableWholeResizer;tableInlineToolbar;formatPainter;listManager;toast;confirmDialog;accessibilityDialog;privacyDialog;formulaDialog;formulaManager;formulaPickMode=!1;videoDialog;videoInserter;formControlDialog;formControlInserter;formControlEditor;templateDialog;signatureDialog;emojiDialog;tooltipDialog;inputPropertyDialog;shortcutsDialog;userGuideDialog;emojiInserter;tooltipManager;fieldInserter;paperSizeManager;pageGuide;scrollContainer=null;_resizeObs=null;_fullscreenHandler=null;embedBridge;selectedTable=null;previousMenuTab=`edit`;inTableContext=!1;pendingStyles=new Map;pendingStylesJustSet=!1;selectionHandler=()=>{this.pendingStyles.size>0&&(this.pendingStylesJustSet?this.pendingStylesJustSet=!1:this.pendingStyles.clear()),this.syncToolbar()};constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){qe(),this.shadow.innerHTML=`
<style>
:host {
...
`,oa=class extends HTMLElement{shadow;targetCell=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${aa}</style>
...
`,ca=class extends HTMLElement{shadow;activeTab=`video`;constructor(){super(),this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${sa}</style>`}open(e=`video`){this.activeTab=e,this.setAttribute(`open`,``),this.render()}close(){this.removeAttribute(`open`)}render(){this.shadow.innerHTML=`<style>${sa}</style>
<div class="overlay" id="overlay">
  ...
  </svg>`},ua={text:`텍스트`,textarea:`여러 줄`,checkbox:`체크박스`,radio:`라디오`,select:`목록 선택`,button:`버튼`,date:`날짜 선택`},da=[`text`,`textarea`,`checkbox`,`radio`,`select`,`button`,`date`],fa=`
...
`;function K(e,t,n=``){return`<div class="field">
  ...
  </div>`}function q(e,t=``,n=`text`){return`<input type="${n}" id="${e}" placeholder="${t}">`}function pa(e,t){return`<select id="${e}">${t.map(([e,t])=>`<option value="${e}">${t}</option>`).join(``)}</select>`}var ma=class extends HTMLElement{shadow;activeType=`text`;connectedCallback(){this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${fa}</style>${this._tpl()}`,this._buildTypeCards(),this._bindEvents(),this._setType(`text`)}open(e){let t=this.shadow.getElementById(`dlg-title`),n=this.shadow.getElementById(`btn-confirm`);t.textContent=e?`입력 요소 편집`:`입력 요소 추가`,n.textContent=e?`수정하기`:`추가하기`,e?(this._setType(e.type),this._fillFields(e)):(this._setType(`text`),this._clearFields()),this.setAttribute(`open`,``),this.shadow.getElementById(`f-label`)?.focus()}close(){this.removeAttribute(`open`)}_tpl(){return`<div class="dlg">
  <div class="hdr">
    ...
    <div class="adv-body" data-adv-body>${e}</div>`}_secText(){return`<div class="specific-section" id="sec-text">
      ...
      ${this._adv(`
        <div class="field">
          ...
          ${pa(`f-btn-style`,[[`default`,`기본 (회색)`],[`primary`,`강조 (파랑)`],[`danger`,`경고 (빨강)`]])}
        </div>
...
`;function J(e,t){return e.replace(/width="24"/,`width="${t}"`).replace(/height="24"/,`height="${t}"`)}function Y(e){return J(e,16)}function X(e){return J(e,14)}function us(e){return J(e,12)}var Z={bold:Y(Da),italic:Y(oo),underline:Y(os),strike:Y(qo),undo:Y(ss),redo:Y(No),alignLeft:Y(rs),alignCenter:Y(es),alignRight:Y(ts),alignJustify:Y(ns),indent:Y(ho),outdent:Y(mo),foreColor:Y(Ta),backColor:Y(eo),lineHeight:Y(Ea),letterSpacing:Y(wo),fileNew:Y(Ga),fileOpen:Y(Ya),save:Y(Lo),fileSaveAs:Y(Wa),print:Y(jo),settings:Y(Vo),clock:Y(za),history:Y(to),cut:Y(Ro),copy:Y(Ha),paste:Y(Ra),pastePlain:Y(La),selectAll:Y(Ko),search:Y(zo),imageEdit:Y(no),image:Y(ro),images:Y(io),videoTag:Y(Ja),embedVideo:Y(Fa),link:Y(po),linkOff:Y(fo),bookmark:Y(ka),signature:Y(Oo),emoji:Y(Wo),tooltip:Y(yo),tooltipList:Y(bo),calendar:Y(Aa),hr:Y(So),symbol:Y(To),youtube:Y(Co),pageBreak:Y(Bo),template:Y(uo),formField:Y(Mo),viewDesign:Y(co),viewHtml:Y(Ba),viewPreview:Y(Ua),viewText:Y(as),viewPage:Y(Ka),fullscreen:Y(vo),fullscreenExit:Y(xo),maximize2_14:X(vo),minimize2_14:X(xo),ruler:Y(Io),grid:Y(Za),hiddenBorder:Y(Ko),table:Y($o),tableProps:Y(Qo),cellProps:Y(lo),mergeCells:Y(Xo),splitCell:Y(Zo),rowAbove:Y(wa),rowBelow:Y(xa),colLeft:Y(Sa),colRight:Y(Ca),rowDelete:Y(Fo),colDelete:Y(Va),tableDelete:Y(is),painterCopy:Y(Eo),painterPaste:Y(Do),formatClear:Y(Po),ul:Y(_o),ol:Y(go),sup:Y(Yo),sub:Y(Jo),a11y:Y(ba),privacy:Y(Ho),form:Y(Go),calc:Y(Uo),userMode:Y(cs),shortcuts:Y(so),guide:Y(Oa),about:Y(ao),folder:Y(Xa),folderOpen:Y(Ya),file:Y(qa),fileText16:Y(Ka),users16:Y(ls),user16:Y(cs),userCircle:Y(Ia),plus:Y(Ao),pencil:Y(ko),trash:Y(is),link16:Y(po),chevronRight:Y(Ma),chevronDown:Y(ja),folder14:X(Xa),folderOpen14:X(Ya),file14:X(qa),fileText14:X(Ka),users14:X(ls),user14:X(cs),grip14:X(Qa),chevronRight12:us(Ma),chevronDown12:us(ja),users12:us(ls),user12:us(cs),fieldText:X(as),fieldNumber:X($a),fieldDate:X(Aa),layoutTemplate48:J(uo,48)},ds={"file:new":`fileNew`,"file:open":`fileOpen`,"file:save":`save`,"file:saveas":`fileSaveAs`,"file:print":`print`,"file:history":`history`,settings:`settings`,"edit:cut":`cut`,"edit:copy":`copy`,"edit:paste":`paste`,"edit:paste-plain":`pastePlain`,"edit:select-all":`selectAll`,"find-replace":`search`,"edit:image-edit":`imageEdit`,image:`image`,"insert:multi-image":`images`,"insert:video":`videoTag`,"insert:embed":`embedVideo`,"insert:link":`link`,"insert:link-remove":`linkOff`,"insert:bookmark":`bookmark`,"insert:signature":`signature`,"insert:emoji":`emoji`,"insert:tooltip":`tooltip`,"insert:tooltip-list":`tooltipList`,"insert:datetime":`calendar`,"insert:hr":`hr`,"insert:symbol":`symbol`,"insert:pagebreak":`pageBreak`,"misc:template":`template`,"view:design":`viewDesign`,"view:html":`viewHtml`,"view:preview":`viewPreview`,"view:text":`viewText`,"view:page":`viewPage`,"view:fullscreen":`fullscreen`,"view:ruler":`ruler`,"view:grid":`grid`,"view:hidden-border":`hiddenBorder`,table:`table`,"table:table-props":`tableProps`,"table:cell-props":`cellProps`,"table:merge":`mergeCells`,"table:split-cell":`splitCell`,"table:row-above":`rowAbove`,"table:row-below":`rowBelow`,"table:col-left":`colLeft`,"table:col-right":`colRight`,"table:row-delete":`rowDelete`,"table:col-delete":`colDelete`,"table:delete":`tableDelete`,"table:align-left":`alignLeft`,"table:align-center":`alignCenter`,"table:align-right":`alignRight`,"format:painter-copy":`painterCopy`,"format:painter-paste":`painterPaste`,"format:clear":`formatClear`,"format:ul":`ul`,"format:ol":`ol`,"format:sup":`sup`,"format:sub":`sub`,"misc:a11y":`a11y`,"misc:privacy":`privacy`,"misc:form":`form`,"misc:calc":`calc`,"misc:user-mode":`userMode`,"help:shortcuts":`shortcuts`,"help:guide":`guide`,"help:about":`about`};function fs(e){return!(e.isTemp||!e.name||e.name.trim().length===0||e.name.startsWith(`임시_`)||e.name.startsWith(`preview_`)||e.name.startsWith(`__`)||e.type===`template`&&e.content==null)}var ps=`
*, *::before, *::after { box-sizing: border-box; }
...
`,ks=class extends HTMLElement{shadow;inserter=new di;activeCatId=ci[0].id;connectedCallback(){this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${Os}</style>
<div class="dlg">
...
</div>`,this._buildCatBar(),this._bind()}open(){this._renderCategory(this.activeCatId),this.setAttribute(`open`,``),setTimeout(()=>this.shadow.getElementById(`search`).focus(),50)}close(){this.removeAttribute(`open`)}_buildCatBar(){let e=this.shadow.getElementById(`cat-bar`);e.innerHTML=``;for(let t of ci){let n=document.createElement(`button`);n.className=`cat-btn${t.id===this.activeCatId?` active`:``}`,n.title=t.label,n.textContent=t.icon,n.dataset.catId=t.id,n.addEventListener(`click`,()=>{this.activeCatId=t.id,this._syncCatBar(),this._renderCategory(t.id),this.shadow.getElementById(`search`).value=``}),e.appendChild(n)}}_syncCatBar(){this.shadow.querySelectorAll(`.cat-btn`).forEach(e=>{e.classList.toggle(`active`,e.dataset.catId===this.activeCatId)})}_renderCategory(e){let t=this.shadow.getElementById(`emoji-area`);t.innerHTML=``;let n=this.inserter.getRecent();if(n.length>0){this._appendSection(t,`최근 사용`,n);let e=document.createElement(`hr`);e.className=`divider`,t.appendChild(e)}let r=ci.find(t=>t.id===e);r&&this._appendSection(t,r.label,r.emojis)}_renderSearch(e){let t=this.shadow.getElementById(`emoji-area`);t.innerHTML=``;let n=ui(e);if(n.length===0){let n=document.createElement(`div`);n.className=`no-result`,n.textContent=`"${e}"에 대한 결과가 없습니다`,t.appendChild(n)}else this._appendSection(t,`검색 결과 (${n.length})`,n)}_appendSection(e,t,n){let r=document.createElement(`div`);r.className=`section-label`,r.textContent=t,e.appendChild(r);let i=document.createElement(`div`);i.className=`emoji-grid`;for(let e of n){let t=document.createElement(`button`);t.className=`emoji-btn`,t.textContent=e,t.title=e,t.addEventListener(`click`,()=>this._pickEmoji(e)),i.appendChild(t)}e.appendChild(i)}_bind(){this.shadow.querySelector(`.x-btn`).addEventListener(`click`,()=>this.close()),this.addEventListener(`click`,e=>{e.composedPath()[0]===this&&this.close()});let e=this.shadow.getElementById(`search`);e.addEventListener(`input`,()=>{let t=e.value.trim();t?this._renderSearch(t):this._renderCategory(this.activeCatId)}),e.addEventListener(`keydown`,e=>{e.key===`Escape`&&(e.stopPropagation(),this.close())})}_pickEmoji(e){this.dispatchEvent(new CustomEvent(`poa-emoji-insert`,{bubbles:!0,composed:!0,detail:{emoji:e}})),this.shadow.getElementById(`search`).value.trim()||this._renderCategory(this.activeCatId)}},As=`
*, *::before, *::after { box-sizing: border-box; }
:host { display: none; position: fixed; inset: 0; z-index: 9999; align-items: center; justify-content: center; }
:host([open]) { display: flex; background: rgba(0,0,0,.45); }
...
.hidden { display: none !important; }
`,js=class extends HTMLElement{shadow;mode=`add`;editId=null;entries=[];connectedCallback(){this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${As}</style>
<div class="dlg">
  <div class="hdr">
...
`,Ns=class extends HTMLElement{shadow;targetInput=null;connectedCallback(){this.shadow||(this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${Ms}</style>${this._tpl()}`,this._bindEvents())}open(e){this.shadow||this.connectedCallback(),this.targetInput=e,this._populate(e),this.setAttribute(`open`,``)}close(){this.removeAttribute(`open`)}_tpl(){return`<div class="dlg">
  <div class="hdr">
    <h3>입력 요소 속성</h3>
    <button class="x-btn" aria-label="닫기">✕</button>
  </div>
...
`;function Fs(e){return new Date(e).toLocaleString(`ko-KR`,{month:`2-digit`,day:`2-digit`,hour:`2-digit`,minute:`2-digit`,second:`2-digit`})}var Is=class extends HTMLElement{shadow;autoSave=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Ps}</style>
<div class="backdrop" id="backdrop">
  <div class="dialog" role="dialog" aria-modal="true" aria-label="문서 이력">
    ...
    <div class="footer">
      ...
      <button class="clear-btn" id="btn-clear">이력 전체 삭제</button>
        ...
        <span class="history-time">${Fs(t.savedAt)}</span>
        <button class="restore-btn" data-id="${String(t.id)}">복원</button>`,n.querySelector(`.restore-btn`).addEventListener(`click`,()=>{this.handleRestore(t)}),e.appendChild(n)}}handleRestore(e){this.dispatchEvent(new CustomEvent(`poa-autosave-restore`,{bubbles:!0,composed:!0,detail:{html:e.html}})),this.close()}},Ls=J(zo,14),Rs=J(Na,12),zs=J(ja,12),Bs=J(Pa,12),Vs={index:`번호`,title:`제목`,updatedAt:`수정일`},Hs=`
:host { display: none; }
:host([open]) { display: block; }
...
`;function Us(e){let t=new Date(e);return`${t.getFullYear()}.${String(t.getMonth()+1).padStart(2,`0`)}.${String(t.getDate()).padStart(2,`0`)}`}var Ws=class extends HTMLElement{shadow;onLoad=null;documents=[];filterQuery=``;sortKey=`updatedAt`;sortOrder=`desc`;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Hs}</style>
<div class="backdrop" id="backdrop">
  <div class="dialog">
    <div class="header">
      <span>문서 목록</span>
    ...
    <div class="search-wrap">
      <div class="search-field">
        <span class="search-icon">${Ls}</span>
...
`,Ks=class extends HTMLElement{shadow;mode=`title`;defaultTitle=`새 문서`;titleResolve=null;unsavedResolve=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Gs}</style><div class="overlay" id="overlay"></div>`,this.shadow.getElementById(`overlay`)?.addEventListener(`click`,e=>{e.target.id===`overlay`&&this._handleCancel()}),this.addEventListener(`keydown`,e=>{e.key===`Escape`&&(e.preventDefault(),this._handleCancel())})}showTitleInput(e){return this.mode=`title`,this.defaultTitle=e,this._render(),this.setAttribute(`open`,``),new Promise(e=>{this.titleResolve=e})}showUnsavedConfirm(){return this.mode=`unsaved`,this._render(),this.setAttribute(`open`,``),new Promise(e=>{this.unsavedResolve=e})}_render(){let e=this.shadow.getElementById(`overlay`);if(this.mode===`title`){e.innerHTML=`
<div class="dialog">
...
</div>`,this.shadow.getElementById(`btn-save`)?.addEventListener(`click`,()=>{this._close(),this.unsavedResolve?.(`save`),this.unsavedResolve=null}),this.shadow.getElementById(`btn-discard`)?.addEventListener(`click`,()=>{this._close(),this.unsavedResolve?.(`discard`),this.unsavedResolve=null}),this.shadow.getElementById(`btn-cancel`)?.addEventListener(`click`,()=>this._handleCancel())}_handleTitleSave(){let e=this.shadow.getElementById(`title-inp`).value.trim()||this.defaultTitle;this._close(),this.titleResolve?.(e),this.titleResolve=null}_handleCancel(){this._close(),this.mode===`title`?(this.titleResolve?.(null),this.titleResolve=null):(this.unsavedResolve?.(`cancel`),this.unsavedResolve=null)}_close(){this.removeAttribute(`open`)}},qs={파일:[{keys:[`Ctrl`,`N`],desc:`새 문서`},{keys:[`Ctrl`,`O`],desc:`열기`},{keys:[`Ctrl`,`S`],desc:`저장`},{keys:[`Ctrl`,`Shift`,`S`],desc:`다른 이름으로 저장`},{keys:[`Ctrl`,`P`],desc:`인쇄`}],편집:[{keys:[`Ctrl`,`Z`],desc:`실행 취소`},{keys:[`Ctrl`,`Y`],desc:`다시 실행`},{keys:[`Ctrl`,`X`],desc:`잘라내기`},{keys:[`Ctrl`,`C`],desc:`복사`},{keys:[`Ctrl`,`V`],desc:`붙여넣기`},{keys:[`Ctrl`,`Shift`,`V`],desc:`서식 없이 붙여넣기`},{keys:[`Ctrl`,`A`],desc:`전체 선택`},{keys:[`Ctrl`,`F`],desc:`찾기`},{keys:[`Ctrl`,`H`],desc:`찾기·바꾸기`}],서식:[{keys:[`Ctrl`,`B`],desc:`굵게`},{keys:[`Ctrl`,`I`],desc:`기울임`},{keys:[`Ctrl`,`U`],desc:`밑줄`},{keys:[`Ctrl`,`Shift`,`X`],desc:`취소선`},{keys:[`Ctrl`,`L`],desc:`왼쪽 정렬`},{keys:[`Ctrl`,`E`],desc:`가운데 정렬`},{keys:[`Ctrl`,`R`],desc:`오른쪽 정렬`},{keys:[`Ctrl`,`J`],desc:`양쪽 정렬`}],표:[{keys:[`Tab`],desc:`다음 셀 이동`},{keys:[`Shift`,`Tab`],desc:`이전 셀 이동`},{keys:[`Tab`],note:`(마지막 셀)`,desc:`새 행 추가`}],보기:[{keys:[`F11`],desc:`전체화면`},{keys:[`Ctrl`,`+`],desc:`확대`},{keys:[`Ctrl`,`-`],desc:`축소`},{keys:[`Ctrl`,`0`],desc:`100% 초기화`}]},Js=[`파일`,`편집`,`서식`,`표`,`보기`];function Ys(e,t){return`${e.map(e=>`<kbd>${e}</kbd>`).join(`<span class="plus">+</span>`)}${t?`<span class="sc-note">&nbsp;${t}</span>`:``}`}var Xs=`
:host { display: none; }
:host([open]) { display: block; }
...
`,Zs=class extends HTMLElement{shadow;activeTab=`파일`;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Xs}</style>
<div class="backdrop" id="backdrop">
  <div class="dialog">
    <div class="header">
      <span>단축키</span>
...
</div>`,this.shadow.getElementById(`btn-close`)?.addEventListener(`click`,()=>this._close()),this.shadow.getElementById(`backdrop`)?.addEventListener(`click`,e=>{e.target.id===`backdrop`&&this._close()}),this.addEventListener(`keydown`,e=>{e.key===`Escape`&&this._close()}),this.shadow.getElementById(`tabs`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-tab]`);t&&(this.activeTab=t.dataset.tab,this._renderTabs(),this._renderContent())})}open(){this.activeTab=`파일`,this.setAttribute(`open`,``),this._renderTabs(),this._renderContent(),requestAnimationFrame(()=>this.shadow.getElementById(`btn-close`)?.focus())}_renderTabs(){this.shadow.getElementById(`tabs`).innerHTML=Js.map(e=>`<button class="tab-btn${e===this.activeTab?` active`:``}" data-tab="${e}">${e}</button>`).join(``)}_renderContent(){this.shadow.getElementById(`content`).innerHTML=qs[this.activeTab].map(({keys:e,note:t,desc:n})=>`
<div class="sc-row">
  <div class="sc-keys">${Ys(e,t)}</div>
  <span class="sc-desc">${n}</span>
</div>`).join(``)}_close(){this.removeAttribute(`open`)}},$={type:J(as,16),bold:J(Da,16),clipboard:J(Ra,16),search:J(zo,16),table:J($o,16),chevron:J(Ma,16),merge:J(Xo,16),rows:J(Fo,16),image:J(ro,16),maximize:J(vo,16),imagePlus:J(no,16),formInput:J(Mo,16),list:J(_o,16),user:J(cs,16)},Qs={기본편집:[{icon:$.type,title:`텍스트 입력`,body:[`에디터 영역을 클릭하면 텍스트를 입력할 수 있습니다.`,`폰트, 크기, 색상 등 서식은 툴바에서 변경하세요.`]},{icon:$.bold,title:`서식 적용`,body:[`텍스트를 선택한 후 툴바 버튼을 클릭하거나 단축키(Ctrl+B, Ctrl+I 등)를 사용하세요.`]},{icon:$.clipboard,title:`복사·붙여넣기`,body:[`외부에서 복사한 내용을 붙여넣을 때 Ctrl+Shift+V 를 사용하면 서식 없이 붙여넣기됩니다.`],tip:`Ctrl+Shift+V 로 서식 없이 붙여넣기`},{icon:$.search,title:`찾기·바꾸기`,body:[`Ctrl+F 로 찾기, Ctrl+H 로 찾기·바꾸기를 열 수 있습니다.`]}],표:[{icon:$.table,title:`표 삽입`,body:[`삽입 탭 → 표 삽입 버튼을 클릭하면 그리드에서 행/열 수를 선택하여 삽입합니다.`]},{icon:$.chevron,title:`셀 이동`,body:[`Tab 키로 다음 셀, Shift+Tab 으로 이전 셀로 이동합니다.`,`마지막 셀에서 Tab 을 누르면 새 행이 자동 추가됩니다.`]},{icon:$.merge,title:`셀 병합·분할`,body:[`표 탭에서 셀 병합/셀 나누기 버튼을 사용하세요.`]},{icon:$.rows,title:`행·열 관리`,body:[`표 탭에서 행/열 삽입·삭제가 가능합니다.`]}],이미지:[{icon:$.image,title:`이미지 삽입`,body:[`삽입 탭 → 이미지 버튼으로 파일을 업로드하거나 URL로 이미지를 삽입할 수 있습니다.`]},{icon:$.maximize,title:`크기 조절`,body:[`삽입된 이미지를 클릭하면 크기 조절 핸들이 표시됩니다.`,`드래그로 크기를 변경하세요.`]},{icon:$.imagePlus,title:`이미지 편집`,body:[`편집 탭 → 이미지 편집에서 자르기, 회전, 반전이 가능합니다.`]}],양식필드:[{icon:$.formInput,title:`필드 삽입`,body:[`삽입 탭 → 양식 필드를 클릭하면 텍스트, 숫자, 날짜 등 다양한 필드를 삽입할 수 있습니다.`]},{icon:$.list,title:`필드 유형`,body:[`텍스트: 일반 문자 입력`,`숫자: 숫자 입력 (천 단위 구분, 원화 등 포맷 지원)`,`날짜: 날짜 선택 (다양한 포맷 지원)`,`계약 정보: 계약명, 계약일, 금액 등 전문 필드`]},{icon:$.user,title:`사용자 모드`,body:[`기타 탭 → 사용자 모드로 보기를 클릭하면 양식 필드만 입력 가능한 사용자 전용 화면으로 전환됩니다.`]}]},$s=[`기본편집`,`표`,`이미지`,`양식필드`],ec=`
:host { display: none; }
:host([open]) { display: block; }
...
`,tc=class extends HTMLElement{shadow;activeTab=`기본편집`;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${ec}</style>
<div class="backdrop" id="backdrop">
  <div class="dialog">
    <div class="header">
      <span>사용자 가이드</span>
...
</div>`,this.shadow.getElementById(`btn-close`)?.addEventListener(`click`,()=>this._close()),this.shadow.getElementById(`backdrop`)?.addEventListener(`click`,e=>{e.target.id===`backdrop`&&this._close()}),this.addEventListener(`keydown`,e=>{e.key===`Escape`&&this._close()}),this.shadow.getElementById(`tabs`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-tab]`);t&&(this.activeTab=t.dataset.tab,this._renderTabs(),this._renderContent())})}open(){this.activeTab=`기본편집`,this.setAttribute(`open`,``),this._renderTabs(),this._renderContent(),requestAnimationFrame(()=>this.shadow.getElementById(`btn-close`)?.focus())}_renderTabs(){this.shadow.getElementById(`tabs`).innerHTML=$s.map(e=>`<button class="tab-btn${e===this.activeTab?` active`:``}" data-tab="${e}">${e}</button>`).join(``)}_renderContent(){let e=Qs[this.activeTab],t=e.length-1;this.shadow.getElementById(`content`).innerHTML=e.map((e,n)=>{let r=e.body.map(e=>`<p class="body-text">${e}</p>`).join(``),i=e.tip?`<div class="tip">${e.tip}</div>`:``;return`
<div class="section${n<t?` has-divider`:``}">
  <h3 class="sec-title">
    <span class="sec-icon">${e.icon}</span>${e.title}
  </h3>
  ${r}${i}
</div>`}).join(``)}_close(){this.removeAttribute(`open`)}},nc=[{id:`file`,label:`파일`},{id:`edit`,label:`편집`},{id:`insert`,label:`삽입`},{id:`view`,label:`보기`},{id:`table`,label:`표`},{id:`format`,label:`서식`},{id:`misc`,label:`기타`},{id:`help`,label:`도움말`}],rc=`
:host { display: block; }
.menubar {
...
`,ic=new Set([`edit`,`insert`,`table`,`format`,`misc`]),ac=class extends HTMLElement{shadow;_activeTab=`edit`;_userMode=!1;_fsHandler=null;busHandler=({tab:e})=>{this._activeTab=e,this.updateActive()};constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){let e=nc.map(e=>`<button class="tab${e.id===this._activeTab?` active`:``}" data-tab="${e.id}">${e.label}</button>`).join(``);this.shadow.innerHTML=`<style>${rc}</style><div class="menubar">${e}</div>`;let t=this.shadow.querySelector(`.menubar`),n=document.createElement(`div`);n.className=`user-area`,n.id=`user-area`;let r=document.createElement(`span`);r.style.cssText=`display:contents`,r.innerHTML=Z.userCircle,n.appendChild(r);let i=document.createElement(`span`);i.className=`user-name-text`,i.id=`user-name-text`,i.textContent=We(),n.appendChild(i);let a=Li();if(a===`admin`){let e=document.createElement(`span`);e.className=`admin-badge`,e.textContent=`관리자`,n.appendChild(e)}a===`write`&&this._applyWriteMode();let o=document.createElement(`div`);o.className=`user-dropdown hidden`,o.id=`user-dropdown`;let s=document.createElement(`div`);s.className=`user-dropdown-label`,s.textContent=`사용자 이름`;let c=document.createElement(`input`);c.type=`text`,c.id=`user-name-input`,c.placeholder=`사용자 이름`;let l=document.createElement(`button`);l.className=`user-dropdown-btn`,l.id=`user-name-confirm`,l.textContent=`확인`,o.append(s,c,l),n.appendChild(o),t.appendChild(n);let u=document.createElement(`button`);u.className=`fullscreen-btn`,u.title=`전체화면으로 보기`;let d=document.createElement(`span`);d.style.cssText=`display:contents`,d.innerHTML=Z.maximize2_14,u.appendChild(d),t.appendChild(u);let f=()=>{let e=!!document.fullscreenElement;d.innerHTML=e?Z.minimize2_14:Z.maximize2_14,u.title=e?`전체화면 종료`:`전체화면으로 보기`};this._fsHandler=f,document.addEventListener(`fullscreenchange`,this._fsHandler),u.addEventListener(`click`,()=>{document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen().catch(()=>{window.parent.postMessage({type:`POA_FULLSCREEN_REQUEST`,enabled:!0},`*`)})}),this.shadow.querySelectorAll(`.tab`).forEach(e=>{e.addEventListener(`mousedown`,t=>{t.preventDefault(),M.emit(N.MENUBAR_CHANGE,{tab:e.dataset.tab})})}),this._bindUserArea(),M.on(N.MENUBAR_CHANGE,this.busHandler)}disconnectedCallback(){M.off(N.MENUBAR_CHANGE,this.busHandler),this._fsHandler&&=(document.removeEventListener(`fullscreenchange`,this._fsHandler),null)}_bindUserArea(){let e=this.shadow.getElementById(`user-area`),t=this.shadow.getElementById(`user-dropdown`),n=this.shadow.getElementById(`user-name-input`),r=this.shadow.getElementById(`user-name-confirm`),i=this.shadow.getElementById(`user-name-text`);e.addEventListener(`mousedown`,e=>{if(e.preventDefault(),e.target.closest(`#user-dropdown`))return;let r=t.classList.contains(`hidden`);t.classList.toggle(`hidden`,!r),r&&(n.value=We(),setTimeout(()=>{n.focus(),n.select()},50))});let a=()=>{let e=n.value.trim()||`사용자`;Ge(e),i.textContent=e,t.classList.add(`hidden`)};r.addEventListener(`mousedown`,e=>{e.preventDefault(),a()}),n.addEventListener(`keydown`,e=>{e.key===`Enter`&&a()}),document.addEventListener(`click`,n=>{e.contains(n.target)||t.classList.add(`hidden`)})}applyUserMode(){this._userMode=!0,ic.has(this._activeTab)&&M.emit(N.MENUBAR_CHANGE,{tab:`file`}),this._applyUserModeStyles()}_applyUserModeStyles(){this._userMode&&this.shadow.querySelectorAll(`.tab`).forEach(e=>{let t=e.dataset.tab;ic.has(t)&&(e.dataset.userDisabled=`true`)})}_applyWriteMode(){this.shadow.querySelectorAll(`.tab`).forEach(e=>{e.dataset.tab===`misc`&&(e.style.display=`none`)}),this._activeTab===`misc`&&M.emit(N.MENUBAR_CHANGE,{tab:`edit`})}updateActive(){this.shadow.querySelectorAll(`.tab`).forEach(e=>{e.classList.toggle(`active`,e.dataset.tab===this._activeTab)})}},oc={text:Z.fieldText,number:Z.fieldNumber,date:Z.fieldDate};function sc(){let e=t(),n=Array.from(new Set(e.map(e=>e.category))),r=[],i=!0;for(let t of n){let n=e.filter(e=>e.category===t);if(n.length!==0){i||r.push([``,`__sep__`]),r.push([t,`__cat__`]),i=!1;for(let e of n)r.push([e.label,`insert:field`,e.id,oc[e.type]])}}return r}var cc={file:[[[`새 문서`,`file:new`],[`열기`,`file:open`],[`저장`,`file:save`],[`다른 이름으로 저장`,`file:saveas`]],[[`인쇄`,`file:print`],[`환경설정`,`settings`],[`문서 이력`,`file:history`]]],edit:[[[`잘라내기`,`edit:cut`],[`복사`,`edit:copy`],[`붙여넣기`,`edit:paste`],[`서식 없이 붙여넣기`,`edit:paste-plain`]],[[`찾기·바꾸기`,`find-replace`],[`이미지 편집`,`edit:image-edit`],[`전체 선택`,`edit:select-all`]]],insert:[[[`이미지`,`image`]],[[`하이퍼링크`,`insert:link`],[`책갈피`,`insert:bookmark`]],[[`서명`,`insert:signature`],[`이모지`,`insert:emoji`]],[[`툴팁`,`insert:tooltip`],[`툴팁 관리`,`insert:tooltip-list`]],[[`날짜·시간`,`insert:datetime`],[`가로줄`,`insert:hr`],[`기호`,`insert:symbol`],[`페이지 구분선`,`insert:pagebreak`],[`템플릿`,`misc:template`]],[[`폼 컨트롤`,`misc:form`]],[{dropdown:!0,id:`doc-field`,label:`양식 필드`,iconKey:`formField`,items:sc()}]],view:[[[`디자인`,`view:design`],[`HTML`,`view:html`],[`미리보기`,`view:preview`],[`텍스트`,`view:text`],[`페이지`,`view:page`]],[[`전체화면`,`view:fullscreen`],[`눈금자`,`view:ruler`],[`그리드`,`view:grid`],[`숨김 테두리`,`view:hidden-border`]]],table:[[[`표 삽입`,`table`],[`표 속성`,`table:table-props`],[`셀 속성`,`table:cell-props`]],[[`셀 병합`,`table:merge`],[`셀 나누기`,`table:split-cell`]],[[`위에 행 삽입`,`table:row-above`],[`아래에 행 삽입`,`table:row-below`],[`왼쪽에 열 삽입`,`table:col-left`],[`오른쪽에 열 삽입`,`table:col-right`]],[[`행 삭제`,`table:row-delete`],[`열 삭제`,`table:col-delete`],[`표 삭제`,`table:delete`]],[[`표 왼쪽 정렬`,`table:align-left`],[`표 가운데 정렬`,`table:align-center`],[`표 오른쪽 정렬`,`table:align-right`]]],format:[[[`서식 복사`,`format:painter-copy`],[`서식 붙여넣기`,`format:painter-paste`],[`서식 제거`,`format:clear`]],[[`글머리 기호`,`format:ul`],[`글머리 번호`,`format:ol`]],[[`위 첨자`,`format:sup`],[`아래 첨자`,`format:sub`]]],misc:[[[`웹 접근성 체크`,`misc:a11y`],[`개인정보 체크`,`misc:privacy`]],[[`계산식`,`misc:calc`]],[[`사용자 모드로 보기`,`misc:user-mode`]]],help:[[[`단축키`,`help:shortcuts`],[`사용자 가이드`,`help:guide`]]]},lc=new Set([`view:design`,`view:html`,`view:preview`,`view:text`,`view:page`]),uc=`
:host {
  display: block;
  --icon-color:         #374151;
...
`,dc=new Set([`file:new`,`file:open`,`settings`]),fc=class extends HTMLElement{shadow;activeTab=`edit`;activeViewMode=`design`;outsideHandler=null;userMode=!1;busHandler=({tab:e})=>{this.activeTab=e,this.render()};viewHandler=({mode:e})=>{this.activeViewMode=e,this.activeTab===`view`&&this.render()};constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.render(),M.on(N.MENUBAR_CHANGE,this.busHandler),M.on(N.VIEW_CHANGE,this.viewHandler)}disconnectedCallback(){M.off(N.MENUBAR_CHANGE,this.busHandler),M.off(N.VIEW_CHANGE,this.viewHandler),this.closeAllDropdowns()}render(){this.closeAllDropdowns();let e=Li()===`write`,t=cc[this.activeTab]??[];e&&this.activeTab===`insert`&&(t=t.map(e=>e.filter(e=>e===null?!0:`dropdown`in e&&e.dropdown?e.id!==`doc-field`:!0)).filter(e=>e.length>0));let n=t,r=[];for(let e=0;e<n.length;e++){e>0&&r.push(`<div class="sep"></div>`),r.push(`<div class="group">`);for(let t of n[e])if(t===null)r.push(`<div class="sep" style="margin:0 2px;"></div>`);else if(`dropdown`in t&&t.dropdown){let e=(t.id===`doc-field`?sc():t.items).map(([e,t,n,r])=>t===`__sep__`?`<hr class="drop-sep">`:t===`__cat__`?`<div class="drop-cat">${e}</div>`:`<div class="drop-item" data-action="${t}"${n?` data-value="${n}"`:``}>${r?`<span class="type-icon">${r}</span>`:``}${e}</div>`).join(``),n=t.iconKey?Z[t.iconKey]??``:``,i=n?`${n}<span>${t.label}</span>`:t.label;r.push(`<div class="dropdown-wrap" id="dd-${t.id}"><button class="btn dropdown-toggle" data-dropdown-id="${t.id}">${i}</button><div class="dropdown-menu" id="menu-${t.id}">${e}</div></div>`)}else{let[e,n,i,a]=t,o=i?` data-value="${i}"`:``,s=lc.has(n)&&n===`view:${this.activeViewMode}`?` active`:``,c=a??e,l=ds[n],u=l?Z[l]:``,d=u?`${u}<span>${e}</span>`:e;r.push(`<button class="btn${s}" data-action="${n}"${o} data-tip="${c}">${d}</button>`)}r.push(`</div>`)}this.shadow.innerHTML=`<style>${uc}</style><div class="ctx-bar">${r.join(``)}</div>`,this.userMode&&this._applyUserModeButtons(),this.shadow.querySelector(`.ctx-bar`).addEventListener(`mousedown`,e=>{let t=e.target,n=t.closest(`.dropdown-toggle`);if(n){let t=n.dataset.dropdownId;if(!t)return;e.preventDefault();let r=this.shadow.getElementById(`menu-${t}`);if(!r)return;let i=r.classList.contains(`open`);this.closeAllDropdowns(),i||(r.classList.add(`open`),this.setupOutsideClick(t));return}let r=t.closest(`.drop-item`);if(r){let t=r.dataset.action,n=r.dataset.value;if(!t)return;e.preventDefault(),this.closeAllDropdowns(),this.dispatchEvent(new CustomEvent(`poa-action`,{bubbles:!0,composed:!0,detail:{type:t,value:n}}));return}let i=t.closest(`.btn`);if(!i||i.disabled)return;let a=i.dataset.action;if(!a)return;e.preventDefault();let o=i.dataset.value;this.dispatchEvent(new CustomEvent(`poa-action`,{bubbles:!0,composed:!0,detail:{type:a,value:o}}))})}closeAllDropdowns(){this.shadow.querySelectorAll(`.dropdown-menu.open`).forEach(e=>e.classList.remove(`open`)),this.outsideHandler&&=(document.removeEventListener(`mousedown`,this.outsideHandler),null)}setupOutsideClick(e){this.outsideHandler=t=>{let n=this.shadow.getElementById(`dd-${e}`);n&&(t.composedPath().includes(n)||this.closeAllDropdowns())},document.addEventListener(`mousedown`,this.outsideHandler)}applyUserMode(){this.userMode=!0,this._applyUserModeButtons()}_applyUserModeButtons(){this.shadow.querySelectorAll(`.btn[data-action]`).forEach(e=>{let t=e.dataset.action??``;dc.has(t)&&(e.disabled=!0,e.title=(e.title||e.textContent?.trim()||``)+` (사용자 모드에서 비활성화)`)})}},pc=[{label:`기본`,value:`inherit`},{label:`Noto Sans KR`,value:`Noto Sans KR, Roboto, sans-serif`},{label:`맑은 고딕`,value:`맑은 고딕, sans-serif`},{label:`나눔고딕`,value:`나눔고딕, sans-serif`},{label:`나눔명조`,value:`나눔명조, serif`},{label:`굴림`,value:`굴림, sans-serif`},{label:`돋움`,value:`돋움, sans-serif`},{label:`바탕`,value:`바탕, serif`},{label:`궁서`,value:`궁서, serif`},{label:`Arial`,value:`Arial, sans-serif`},{label:`Times New Roman`,value:`Times New Roman, serif`},{label:`Courier New`,value:`Courier New, monospace`},{label:`Georgia`,value:`Georgia, serif`},{label:`Verdana`,value:`Verdana, sans-serif`},{label:`Tahoma`,value:`Tahoma, sans-serif`}],mc=[`8`,`9`,`10`,`11`,`12`,`14`,`16`,`18`,`20`,`24`,`28`,`32`,`36`,`48`,`72`],hc=[`1`,`1.2`,`1.4`,`1.5`,`1.6`,`1.8`,`2.0`,`2.5`],gc=[`0px`,`0.5px`,`1px`,`1.5px`,`2px`,`3px`,`4px`],_c=`
:host {
  display: block;
  --icon-color:         #374151;
  --icon-hover-bg:      #F3F4F6;
...
<div class="bar">
  ...
  ${Bi()?`<span class="mode-label">양식 입력 모드</span>`:``}
  <div class="sep"></div>
...
`,Tc=class extends HTMLElement{shadow;editor=new ta;originalSrc=``;currentDataUrl=``;busy=!1;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${wc}</style>
<div class="backdrop" id="backdrop">
...
`;function Dc(e){return e<1024*1024?`${(e/1024).toFixed(1)}KB`:`${(e/1024/1024).toFixed(1)}MB`}var Oc=class extends HTMLElement{shadow;uploader=new ia;uploadConfig=null;selectedFiles=[];busy=!1;onErrorFn=null;setOnError(e){this.onErrorFn=e}constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Ec}</style>
<div class="backdrop" id="backdrop">
...
.grid-picker {
  display: grid;
  grid-template-columns: repeat(${kc}, ${jc}px);
  gap: ${Mc}px;
  cursor: crosshair;
}
.gc {
  width: ${jc}px; height: ${jc}px;
...
`,Pc=class e extends HTMLElement{shadow;selectedPreset=`border-all`;gridCells=[];constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Nc}</style>
<div class="overlay" id="overlay">
  <div class="dialog" role="dialog" aria-modal="true">
    <div class="dlg-hd">
...
</div>`,this.shadow.getElementById(`btn-close`).addEventListener(`click`,()=>this.close()),this.shadow.getElementById(`overlay`).addEventListener(`click`,e=>{e.target.id===`overlay`&&this.close()})}open(e){this.classList.add(`open`);let t=this.shadow.getElementById(`dlg-body`),n=this.shadow.getElementById(`dlg-title`);e?(n.textContent=`표 속성`,this.renderProps(t,e)):(n.textContent=`표`,this.renderInsert(t))}close(){this.classList.remove(`open`),this.gridCells=[]}renderInsert(e){let t=e.ownerDocument;e.innerHTML=``;let n=t.createElement(`div`);n.className=`preset-grid`;for(let e of In){let r=t.createElement(`div`);r.className=`preset-item`+(e.id===this.selectedPreset?` active`:``),r.dataset.pid=e.id,r.innerHTML=`${e.icon}<span class="preset-lbl">${e.label}</span>`,r.addEventListener(`click`,()=>this.selectPreset(e.id)),n.appendChild(r)}e.appendChild(n);let r=t.createElement(`hr`);r.className=`sep`,e.appendChild(r);let i=t.createElement(`div`);i.className=`grid-wrap`;let a=t.createElement(`div`);a.className=`grid-picker`,this.gridCells=[];for(let e=0;e<Ac;e++)for(let n=0;n<kc;n++){let r=t.createElement(`div`);r.className=`gc`,r.dataset.r=String(e),r.dataset.c=String(n),a.appendChild(r),this.gridCells.push(r)}let o=t.createElement(`div`);o.className=`grid-size`,o.textContent=``,a.addEventListener(`mousemove`,e=>{if(!e.target.closest(`.grid-picker`))return;let t=a.getBoundingClientRect(),n=jc+Mc,r=Math.min(Math.floor((e.clientX-t.left)/n),kc-1),i=Math.min(Math.floor((e.clientY-t.top)/n),Ac-1);this.highlightGrid(i,r),o.textContent=`${r+1} × ${i+1}`}),a.addEventListener(`mouseleave`,()=>{this.highlightGrid(-1,-1),o.textContent=``}),a.addEventListener(`click`,e=>{let t=a.getBoundingClientRect(),n=jc+Mc,r=Math.min(Math.floor((e.clientX-t.left)/n),kc-1),i=Math.min(Math.floor((e.clientY-t.top)/n),Ac-1);this.insertTable(i+1,r+1)}),i.appendChild(a),i.appendChild(o),e.appendChild(i)}selectPreset(e){this.selectedPreset=e,this.shadow.querySelectorAll(`.preset-item`).forEach(t=>{t.classList.toggle(`active`,t.dataset.pid===e)})}highlightGrid(e,t){for(let n of this.gridCells){let r=parseInt(n.dataset.r??`0`),i=parseInt(n.dataset.c??`0`);n.classList.toggle(`hl`,r<=e&&i<=t)}}insertTable(e,t){let n=In.find(e=>e.id===this.selectedPreset)??In[0],r={rows:e,cols:t,width:`100%`,align:`center`,...n.baseOptions};this.dispatchEvent(new CustomEvent(`poa-table-insert`,{bubbles:!0,composed:!0,detail:{options:r,presetId:n.id}})),this.close()}renderProps(t,n){let r=n.style.width||`100%`,i=e.rgbToHex(n.style.backgroundColor)||`#ffffff`,a=n.querySelector(`td,th`)?.style.border.match(/solid\s+(#[\da-fA-F]{3,6}|[a-z]+)/i),o=a?a[1]:`#000000`,s=`left`;n.style.marginLeft===`auto`&&n.style.marginRight===`auto`?s=`center`:n.style.marginLeft===`auto`&&(s=`right`);let c=n.style.letterSpacing||``,l=parseFloat(c),u=Number.isFinite(l)?l:0,d=(e,t,n)=>`<button class="align-btn${s===e?` active`:``}" data-align="${e}">${t} ${n}</button>`;t.innerHTML=`
...
`,Lc=class extends HTMLElement{shadow;bookmarks=[];editingId=null;editingAnchor=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Ic}</style>
<div class="backdrop" id="backdrop">
  <div class="dialog" role="dialog" aria-modal="true" aria-label="링크 삽입">
    ...
    `).join(``),this.refreshDatetimePreviews(),e.addEventListener(`click`,e=>{let t=e.target.closest(`[data-preset]`);if(!t)return;let n=Fc[parseInt(t.dataset.preset??`0`)]?.fn()??``;this.dispatch(`poa-datetime-insert`,{text:n}),this.close()}))}refreshDatetimePreviews(){Fc.forEach((e,t)=>{let n=this.shadow.getElementById(`dt-prev-${t}`);n&&(n.textContent=e.fn())})}dispatch(e,t){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:t}))}},Rc=`
:host { display: none; }
:host([open]) {
  display: flex; align-items: center; gap: 6px;
...
`,zc=class extends HTMLElement{shadow;img=null;aspectLocked=!1;naturalW=0;naturalH=0;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Rc}</style>
<label>너비</label>
...
`,Hc=class extends HTMLElement{shadow;resolvePromise=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Bc}</style>${Vc}`,this.bindEvents()}show(e,t=`확인`){let n=this.shadow.getElementById(`dlg-title`),r=this.shadow.getElementById(`dlg-message`);return n&&(n.textContent=t),r&&(r.textContent=e),this.setAttribute(`open`,``),new Promise(e=>{this.resolvePromise=e})}close(e){this.removeAttribute(`open`),this.resolvePromise?.(e),this.resolvePromise=null}bindEvents(){this.shadow.getElementById(`btn-ok`)?.addEventListener(`click`,()=>this.close(!0)),this.shadow.getElementById(`btn-cancel`)?.addEventListener(`click`,()=>this.close(!1)),this.shadow.getElementById(`overlay`)?.addEventListener(`click`,e=>{e.target.id===`overlay`&&this.close(!1)}),this.addEventListener(`keydown`,e=>{e.key===`Escape`&&(e.preventDefault(),this.close(!1))})}},Uc={error:`●`,warning:`▲`,info:`ℹ`},Wc={error:`#DC2626`,warning:`#D97706`,info:`#2563EB`},Gc=`
:host { display: none; }
:host([open]) { display: block; }
...
`,Kc=class extends HTMLElement{shadow;issues=[];contentEl=null;rerunFn=null;currentFilter=`all`;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Gc}</style>
<div class="overlay" id="overlay">
  <div class="dialog">
    <div class="header">
      <h2>웹 접근성 검사 결과</h2>
...
`,Zc=class extends HTMLElement{shadow;items=[];filteredType=`all`;onModified=null;onConfirmFn=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${Xc}</style><slot></slot>`}setup(e,t){this.onModified=e,this.onConfirmFn=t}startLoading(){this.setAttribute(`open`,``),this.shadow.innerHTML=`<style>${Xc}</style>
<div class="overlay">
  <div class="dialog">
    <div class="header">
      <h2>개인정보 검사</h2>
...
<div class="card" data-level="${e.riskLevel}" data-id="${e.id}">
  <div class="card-header" data-toggle="${e.id}">
    <span class="card-icon">${Jc[e.riskLevel]}</span>
    <span class="card-label">${e.label}</span>
    <span class="card-risk">${Yc[e.riskLevel]}</span>
    <span class="card-toggle">∨</span>
  </div>
  <div class="card-body" id="body-${e.id}">
    <div class="raw-text">"${Qc(e.raw)}"</div>
...
`,el=class extends HTMLElement{shadow;currentTable=null;currentRow=1;currentCol=1;pickBar=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${$c}</style>`}open(e){this.currentTable=e.table,this.currentRow=e.cellRow,this.currentCol=e.cellCol,this.setAttribute(`open`,``),this.render(e.existingFormula,e.initialRange)}close(){this.removeAttribute(`open`),this.exitPickMode(),this.currentTable=null}applyRange(e,t,n,r){this.exitPickMode();let i=e=>this.shadow.getElementById(e),a=(e,t)=>{let n=i(e);n&&(n.value=String(t))};a(`sr`,e),a(`sc`,t),a(`er`,n),a(`ec`,r)}render(e,t){let n=e?.fn??`SUM`,r=e?.format??`integer`,i=e?.decimalPlaces??2,[a,o,s,c]=e?.range??t??[1,1,1,1],l=e?.targetRow??this.currentRow,u=e?.targetCol??this.currentCol,d=!e||e.targetRow===this.currentRow&&e.targetCol===this.currentCol,f=e?.style?.backgroundColor??`#ffffff`,p=e?.style?.color??`#000000`,m=(e,t)=>`<label><input type="radio" name="fn" value="${e}"${n===e?` checked`:``}> ${e} (${t})</label>`,h=(e,t)=>`<label><input type="radio" name="format" value="${e}"${r===e?` checked`:``}> ${t}</label>`;this.shadow.innerHTML=`<style>${$c}</style>
<div class="overlay" id="overlay">
  <div class="dialog" id="dialog">
    <div class="header">
      <h2>계산식 설정</h2>
    ...
    <div class="footer">
      ...
      ">취소</button>`,document.body.appendChild(e),this.pickBar=e,e.querySelector(`#cancel-pick`)?.addEventListener(`click`,()=>this.exitPickMode()),this.dispatchEvent(new CustomEvent(`poa-formula-start-pick`,{bubbles:!0}))}exitPickMode(){this.shadow.getElementById(`overlay`)?.classList.remove(`pick-mode`),this.pickBar?.remove(),this.pickBar=null}};customElements.get(`poa-menubar`)||customElements.define(`poa-menubar`,ac),customElements.get(`poa-context-toolbar`)||customElements.define(`poa-context-toolbar`,fc),customElements.get(`poa-toolbar`)||customElements.define(`poa-toolbar`,yc),customElements.get(`poa-status-bar`)||customElements.define(`poa-status-bar`,bc),customElements.get(`poa-settings-dialog`)||customElements.define(`poa-settings-dialog`,hn),customElements.get(`poa-file-manager-dialog`)||customElements.define(`poa-file-manager-dialog`,Is),customElements.get(`poa-find-replace-dialog`)||customElements.define(`poa-find-replace-dialog`,Cc),customElements.get(`poa-image-edit-dialog`)||customElements.define(`poa-image-edit-dialog`,Tc),customElements.get(`poa-image-dialog`)||customElements.define(`poa-image-dialog`,Oc),customElements.get(`poa-table-dialog`)||customElements.define(`poa-table-dialog`,Pc),customElements.get(`poa-cell-split-dialog`)||customElements.define(`poa-cell-split-dialog`,oa),customElements.get(`poa-link-dialog`)||customElements.define(`poa-link-dialog`,Lc),customElements.get(`poa-image-toolbar`)||customElements.define(`poa-image-toolbar`,zc),customElements.get(`poa-confirm-dialog`)||customElements.define(`poa-confirm-dialog`,Hc),customElements.get(`poa-accessibility-dialog`)||customElements.define(`poa-accessibility-dialog`,Kc),customElements.get(`poa-privacy-dialog`)||customElements.define(`poa-privacy-dialog`,Zc),customElements.get(`poa-formula-dialog`)||customElements.define(`poa-formula-dialog`,el),customElements.get(`poa-video-dialog`)||customElements.define(`poa-video-dialog`,ca),customElements.get(`poa-form-control-dialog`)||customElements.define(`poa-form-control-dialog`,ma),customElements.get(`poa-template-tree`)||customElements.define(`poa-template-tree`,ms),customElements.get(`poa-template-dialog`)||customElements.define(`poa-template-dialog`,vs),customElements.get(`poa-signature-dialog`)||customElements.define(`poa-signature-dialog`,Ds),customElements.get(`poa-emoji-dialog`)||customElements.define(`poa-emoji-dialog`,ks),customElements.get(`poa-tooltip-dialog`)||customElements.define(`poa-tooltip-dialog`,js),customElements.get(`poa-input-property-dialog`)||customElements.define(`poa-input-property-dialog`,Ns),customElements.get(`poa-document-list-dialog`)||customElements.define(`poa-document-list-dialog`,Ws),customElements.get(`poa-doc-title-dialog`)||customElements.define(`poa-doc-title-dialog`,Ks),customElements.get(`poa-shortcuts-dialog`)||customElements.define(`poa-shortcuts-dialog`,Zs),customElements.get(`poa-user-guide-dialog`)||customElements.define(`poa-user-guide-dialog`,tc),customElements.get(`poa-editor`)||customElements.define(`poa-editor`,ea);var{width:tl,height:nl}=Wi(),rl=document.getElementById(`editor`);rl&&(tl!==`100%`&&(rl.style.width=tl),nl!==`100%`&&(rl.style.height=nl,rl.style.flex=`none`));var il=J(Ka,36),al=J(ls,14),ol=J(cs,14);function sl(e){return D.sanitize(e,{USE_PROFILES:{svg:!0,svgFilters:!0}})}function cl(e){return e.type===`template`&&!e.isTemp&&!e.name?.startsWith(`임시_`)&&!e.name?.startsWith(`preview_`)&&!e.name?.startsWith(`__`)&&(e.name?.trim().length??0)>0&&e.content!=null}var ll=class{container;mgr;publicGrid;privateGrid;constructor(e){this.container=e,this.mgr=new ya}renderTemplateSelector(){this.container.innerHTML=``;let e=document.createElement(`div`);e.className=`user-mode-page`;let t=document.createElement(`h2`);t.className=`user-mode-title`,t.textContent=`양식 선택`,e.appendChild(t);let[n,r]=this._buildSection(`공용 양식`,al);this.publicGrid=r,e.appendChild(n);let[i,a]=this._buildSection(`내 양식`,ol);this.privateGrid=a,e.appendChild(i),this.container.appendChild(e),this._renderSections(this.mgr.getAll().filter(cl)),this._refreshFromServer()}_buildSection(e,t){let n=document.createElement(`section`);n.className=`user-mode-section`;let r=document.createElement(`h3`);r.className=`user-mode-section-header`;let i=document.createElement(`span`);i.className=`section-header-icon`,i.innerHTML=sl(t);let a=document.createElement(`span`);a.textContent=e,r.appendChild(i),r.appendChild(a),n.appendChild(r);let o=document.createElement(`div`);return o.className=`user-mode-card-grid`,n.appendChild(o),[n,o]}async _refreshFromServer(){try{let e=await G.getTemplates();this._renderSections(e.filter(cl))}catch{}}_renderSections(e){let t=new Set,n=e.filter(e=>t.has(e.id)?!1:(t.add(e.id),!0)),r=new Map;for(let e of n){let t=`${e.isPublic?`pub`:`pri`}|${e.name}`,n=r.get(t);(!n||e.updatedAt>n.updatedAt)&&r.set(t,e)}let i=Array.from(r.values()),a=i.filter(e=>e.isPublic),o=i.filter(e=>!e.isPublic);this._renderCards(this.publicGrid,a,`public`,`등록된 공용 양식이 없습니다.`),this._renderCards(this.privateGrid,o,`private`,`저장된 개인 양식이 없습니다.`)}_renderCards(e,t,n,r){if(e.innerHTML=``,t.length===0){let t=document.createElement(`p`);t.className=`user-mode-empty`,t.textContent=r,e.appendChild(t)}else for(let r of t)e.appendChild(this._buildCard(r,n))}_buildCard(e,t){let n=document.createElement(`div`);n.className=`user-mode-card user-mode-card--${t}`;let r=document.createElement(`div`);r.className=`user-mode-card-icon`,r.innerHTML=sl(il);let i=document.createElement(`div`);return i.className=`user-mode-card-name`,i.textContent=e.name,n.appendChild(r),n.appendChild(i),n.addEventListener(`click`,()=>{window.location.href=Ui(e.id)}),n}static async loadTemplateById(e){if(e===`__preview__`){let e=sessionStorage.getItem(`poa-preview-html`);return e?{id:`__preview__`,type:`template`,name:`미리보기`,parentId:null,content:e,isPublic:!1,createdAt:Date.now(),updatedAt:Date.now(),order:0}:null}let t=U(e);if(t!==null)try{return await G.getTemplate(t)}catch{}return new ya().getById(e)??null}};if(Li()===`user`){let e=Vi();if(e){let t=await ll.loadTemplateById(e),n=document.getElementById(`editor`);t?.content&&n.setHTML(t.content),n.enterUserMode(t?.name??`문서`)}else document.getElementById(`editor-root`).classList.add(`hidden`),document.body.classList.add(`user-mode`),new ll(document.getElementById(`user-mode-root`)).renderTemplateSelector()}